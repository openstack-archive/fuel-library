...
# Copy masternode's .ssh/id*.pub to all bootstrap images
  ...
  sqfs=/var/www/nailgun/bootstraps/37d280a1-98cc-4609-8682-a5ec7a7f8774/root.squashfs
  test -e /var/www/nailgun/bootstraps/37d280a1-98cc-4609-8682-a5ec7a7f8774/root.squashfs || return 0
