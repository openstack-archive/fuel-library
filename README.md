...
will skip checking the upstream module dependencies. The upstream modules
defined in the fuel-library Puppetfile are automatically excluded from lint
tests. To prevent non-upstream modules that live in fuel-library from being
included in lint tests, add the name of the module to the
utils/jenkins/modules.disable_rake-lint file.
