...
#LP1515988
find %{buildroot}/etc/puppet/%{openstack_version}/modules -type d -name .git -exec rm -rf {} \;
find %{buildroot}/etc/puppet/%{openstack_version}/modules -type d -name spec -exec rm -rf {} \;
