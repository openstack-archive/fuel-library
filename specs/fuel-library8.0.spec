...
install -m 0660 %{files_source}/umm/issue.mm %{buildroot}/etc/issue.mm
install -m 0660 %{files_source}/umm/umm.conf %{buildroot}/etc/umm.conf
install -m 0770 %{files_source}/umm/umm_svc %{buildroot}/usr/lib/umm/umm_svc
install -m 0770 %{files_source}/umm/umm_svc.rh6 %{buildroot}/usr/lib/umm/umm_svc.local
install -m 0770 %{files_source}/umm/umm_vars  %{buildroot}/files/umm//usr/lib/umm/umm_vars
install -m 0770 %{files_source}/umm/umm  %{buildroot}/usr/local/bin/umm
install -m 0770 %{files_source}/umm/umm.sh  %{buildroot}/etc/profile.d/umm.sh
install -m 0660 %{files_source}/umm/etc/init/umm-br.conf  %{buildroot}/etc/init/umm-br.conf
install -m 0660 %{files_source}/umm/umm-console.conf  %{buildroot}/etc/init/umm-console.conf
install -m 0660 %{files_source}/umm/umm-run.conf  %{buildroot}/etc/init/umm-run.conf
install -m 0660 %{files_source}/umm/umm-tr.conf  %{buildroot}/etc/init/umm-tr.conf
install -m 0770 %{files_source}/umm/umm-install.rh6 %{buildroot}/usr/lib/umm/umm-install.rh6
