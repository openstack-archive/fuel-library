...
%post
[ -L /etc/puppet/modules ] && unlink /etc/puppet/modules && ln -s  /etc/puppet/2014.2-%{version}/modules /etc/puppet/modules
[ -L /etc/puppet/manifests ] && unlink /etc/puppet/manifests && ln -s  /etc/puppet/2014.2-%{version}/manifests /etc/puppet/manifests
