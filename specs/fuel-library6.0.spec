...
%define files_source %{_builddir}/%{name}-%{version}
...
install -m 0755 %{files_source}/ceilometer/files/ocf/ceilometer-agent-central %{buildroot}/usr/lib/ocf/resource.d/mirantis/ceilometer-agent-central
install -m 0755 %{files_source}/ceilometer/files/ocf/ceilometer-alarm-evaluator %{buildroot}/usr/lib/ocf/resource.d/mirantis/ceilometer-alarm-evaluator
