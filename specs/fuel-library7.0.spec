...
BuildRequires: ruby21(abi)
BuildRequires: ruby21-rubygem(json)
BuildRequires: ruby21-rubygem(librarianp)
BuildRequires: ruby21-rubygem(rsync)
BuildRequires: rubgems21
BuildRequires: rubygem-librarian-puppet
Requires: fuel-misc
