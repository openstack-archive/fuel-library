...
eos
  ...
  it 'can enable maintenance mode' do
    @class.expects(:run).with 'pcs property set maintenance-mode=true'
    @class.manage_cluster
  end

  it 'can disable maintenance mode' do
    @class.expects(:run).with 'pcs property set maintenance-mode=false'
    @class.unmanage_cluster
  end

  it 'can set no-quorum policy' do
    @class.expects(:run).with 'pcs property set no-quorum-policy=ignore'
