...
class cluster::haproxy_ocf (
  ...
  if $primary_controller {
    ...
    Cs_resource[$service_name] -> Cs_colocation['vip_public-with-haproxy'] -> Service['haproxy']
    Cs_resource[$service_name] -> Cs_colocation['vip_management-with-haproxy'] -> Service['haproxy']
  } else {
    File['haproxy-ocf'] -> Service['haproxy']
  }
