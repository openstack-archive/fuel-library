module Puppet
  newtype(:cs_order) do
    desc 'Type for manipulating Corosync/Pacemkaer ordering entries.  Order
    ...
    validate do
      ...
      fail 'Option "first" is required!' unless parameter :first
      fail 'Option "second" is required!' unless parameter :second
    end
