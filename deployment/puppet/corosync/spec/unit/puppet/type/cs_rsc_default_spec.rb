...
describe Puppet::Type.type(:cs_rsc_default) do
  subject do
    Puppet::Type.type(:cs_rsc_default)
  end
  ...
  describe 'when autorequiring resources' do
    ...
    it 'should autorequire the corresponding resources' do
      ...
      expect(required_resources.first.source).to eq @csshadow
    end
  end
