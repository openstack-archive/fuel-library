...
class ceilometer::params {
  ...
  case $::osfamily {
    'RedHat': {
      ...
      $anotification_package      = 'openstack-ceilometer-agent-notification'
      # service names
      ...
      $anotification_service      = 'openstack-ceilometer-agent-notification'
    }
    'Debian': {
      # package names
      ...
      $anotification_package      = 'ceilometer-agent-notification'
      # service names
      ...
      $anotification_service      = 'ceilometer-agent-notification'
