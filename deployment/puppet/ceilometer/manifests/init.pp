...
class ceilometer(
  ...
  if $use_syslog and !$debug { #syslog and nondebug case
    ...
    File['ceilometer-logging.conf'] ~> Service['ceilometer-api']
    File['ceilometer-logging.conf'] ~> Service['ceilometer-collector']
    File['ceilometer-logging.conf'] ~> Service['ceilometer-agent-central']
    File['ceilometer-logging.conf'] ~> Service['ceilometer-agent-compute']
