module Service
  ...
  # could this service be an upstart service?
  # @param value [String] service name
  # @return [TrueClass,FalseClass]
  def upstart_service?(value)
    File.exists? File.join UPSTART_DIR, value + '.conf'
  end

  # could this service be a SysV Init service?
  # @param value [String] service name
  # @return [TrueClass,FalseClass]
  ...
  # is this upstart service enabled?
  # @param value [String] service name
  # @return [TrueClass,FalseClass]
  ...
  # is this RedHat service enabled?
  # @param value [String] service name
  # @return [TrueClass,FalseClass]
  ...
  # is this Upstart service running?
  # @param value [String] service name
  # @return [TrueClass,FalseClass]
  ...
  # is this SysV Init service running?
  # @param value [String] service name
  # @return [TrueClass,FalseClass]
  ...
  # is this SysV Init service enabled?
  # @param value [String] service name
  # @return [TrueClass,FalseClass]
  ...
  # is this service enabled? whatever type it is
  # @param value [String] service name
  # @return [TrueClass,FalseClass]
  ...
  # is this service running? whatever type it is
  # @param value [String] service name
  # @return [TrueClass,FalseClass]
