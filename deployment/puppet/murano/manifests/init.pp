...
#
# [*identity_host*]
#  (Optional) Admin identity host
#  Defaults to '127.0.0.1'
#
# [*identity_port*]
#  (Optional) Admin identity port
#  Defaults to '35357'
#
# [*identity_protocol*]
#  (Optional) Admin identity protocol
#  Defaults to 'http'
#
# [*use_neutron*]
#  (Optional) Whet
...
class murano(
  ...
  $api_url = "http://${service_host}:${service_port}"
