...
class murano::params {
  ...
  $rabbit_init_script_name  = 'rabbit-server-murano'
  ...
  case $::osfamily {
    'RedHat': {
      ...
      $init_install_cmd          = "chkconfig --add '/etc/init.d/${rabbit_init_script_name}'"
    }
    'Debian': {
      # package names
      ...
      $init_install_cmd          = "update-rc.d '${rabbit_init_script_name}' defaults"
    }
    default: {
