...
Puppet::Type.type(:l23_stored_config).provide(:lnx_ubuntu16, :parent => Puppet::Provider::L23_stored_config_ubuntu) do

  include PuppetX::FileMapper

  confine    :l23_os => :ubuntu16
  defaultfor :l23_os => :ubuntu16
