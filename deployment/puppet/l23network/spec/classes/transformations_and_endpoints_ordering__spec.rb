...
eof
  ...
  context 'with transformations and endpoint for bond' do
    ...
    it do
      should contain_L23_stored_config('eth2').that_comes_before('L23_stored_config[bond0]')
    end
    it do
      should contain_L23_stored_config('eth3').that_comes_before('L23_stored_config[bond0]')
    end
