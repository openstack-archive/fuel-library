...
#"BOOTPROTO=none", "DEVICE=ovs-bondlacp1", "ONBOOT=yes", "MTU=9000", "TYPE=OVSBond", "OVS_BRIDGE=br0", "OVS_OPTIONS=\"bond_mode=balance-tcp other_config:bond-miimon-interval=50 lacp=active other_config:lacp-time=fast\"", "DEVICETYPE=ovs", "BOND_IFACES=\"eth2 eth3\"
