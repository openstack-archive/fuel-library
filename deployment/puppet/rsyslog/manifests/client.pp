...
::rsyslog::imfile { "50-quantum-server" :
...
::rsyslog::imfile { "50-quantum-ovs-cleanup" :
...
::rsyslog::imfile { "50-quantum-rescheduling" :
...
::rsyslog::imfile { "50-quantum-ovs-agent" :
...
::rsyslog::imfile { "50-quantum-l3-agent" :
...
::rsyslog::imfile { "50-quantum-dhcp-agent" :
...
::rsyslog::imfile { "50-quantum-metadata-agent" :
