...
class cobbler::profile::ubuntu_1204_x86_64(
  ...
  $kopts = "auto=true priority=critical locale=en_US net.ifnames=1 biosdevname=0 netcfg/choose_interface=auto netcfg/dhcp_timeout=120 netcfg/link_detection_timeout=20 elevator=deadline",
  ){
