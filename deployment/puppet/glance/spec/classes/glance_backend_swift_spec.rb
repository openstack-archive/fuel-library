...
describe 'glance::backend::swift' do
  ...
  describe 'when default parameters' do
    ...
    it 'configures glance-cache.conf' do
      is_expected.to contain_glance_cache_config('DEFAULT/swift_store_key').with_value('key')
      is_expected.to contain_glance_cache_config('DEFAULT/swift_store_user').with_value('user')
      ...
      is_expected.to contain_glance_cache_config('DEFAULT/swift_store_auth_address').with_value('127.0.0.1:5000/v2.0/')
  ...
  describe 'when overriding parameters' do
    ...
    it 'configures glance-cache.conf' do
      ...
      is_expected.to contain_glance_cache_config('DEFAULT/swift_store_auth_address').with_value('127.0.0.2:8080/v1.0/')
    end
  end
end
