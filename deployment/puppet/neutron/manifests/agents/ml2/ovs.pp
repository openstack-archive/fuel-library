...
class neutron::agents::ml2::ovs (
  ...
  #note(xenolog): While merege with upstream we should disable this requirement,
  # because we use L23network at early (netconfig) stage.
  #require vswitch::ovs
  ...
  if ($bridge_mappings != []) {
    ...
    #note(xenolog): While merege with upstream we should disable this,
    # because this bridges creates at early (netconfig) stage.
