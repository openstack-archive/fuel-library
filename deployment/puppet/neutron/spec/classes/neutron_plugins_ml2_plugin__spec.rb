...
describe 'neutron::examples::ml2_plugin' do
  ...
  it '(vlan) configures ml2_conf.ini' do
    should contain_neutron_plugin_ml2('ml2/type_drivers').with_value('vlan')
    should contain_neutron_plugin_ml2('ml2/tenant_network_types').with_value('vlan')
...
describe 'neutron::examples::ml2_plugin' do
  ...
  it '(gre) configures ml2_conf.ini' do
    should contain_neutron_plugin_ml2('ml2/type_drivers').with_value('gre')
    should contain_neutron_plugin_ml2('ml2/tenant_network_types').with_value('gre')
    should contain_neutron_plugin_ml2('ml2/mechanism_drivers').with_value('openvswitch')
...
describe 'neutron::examples::ml2_plugin' do
  ...
  it '(gre) configures ml2_conf.ini' do
    should contain_neutron_plugin_ml2('ml2/type_drivers').with_value('vxlan')
    should contain_neutron_plugin_ml2('ml2/tenant_network_types').with_value('vxlan')
    should contain_neutron_plugin_ml2('ml2/mechanism_drivers').with_value('openvswitch')
