...
describe 'neutron::examples::ml2_plugin' do
  ...
  it '(vlan) configures ml2_conf.ini' do
    should contain_neutron_plugin_ml2('ml2/type_drivers').with_value('local,flat,vlan')
    should contain_neutron_plugin_ml2('ml2/tenant_network_types').with_value('local,flat,vlan')
    should contain_neutron_plugin_ml2('ml2/mechanism_drivers').with_value('openvswitch')
    should contain_neutron_plugin_ml2('ml2_type_vlan/network_vlan_ranges').with_value("physnet1,physnet2:1000:1030")
  end
...
describe 'neutron::examples::ml2_plugin' do
  ...
  it '(gre) configures ml2_conf.ini' do
    should contain_neutron_plugin_ml2('ml2/type_drivers').with_value('local,flat,gre')
    should contain_neutron_plugin_ml2('ml2/tenant_network_types').with_value('local,flat,gre')
    should contain_neutron_plugin_ml2('ml2/mechanism_drivers').with_value('openvswitch')
    should contain_neutron_plugin_ml2('ml2_type_gre/tunnel_id_ranges').with_value("3000:65535")
  end
...
describe 'neutron::examples::ml2_plugin' do
  ...
  it '(gre) configures ml2_conf.ini' do
    should contain_neutron_plugin_ml2('ml2/type_drivers').with_value('local,flat,vxlan')
    should contain_neutron_plugin_ml2('ml2/tenant_network_types').with_value('local,flat,vxlan')
    should contain_neutron_plugin_ml2('ml2/mechanism_drivers').with_value('openvswitch')
    should contain_neutron_plugin_ml2('ml2_type_vxlan/vni_ranges').with_value("3000:65535")
    should contain_neutron_plugin_ml2('ml2_type_vxlan/vxlan_group').with_value("None")
  end
