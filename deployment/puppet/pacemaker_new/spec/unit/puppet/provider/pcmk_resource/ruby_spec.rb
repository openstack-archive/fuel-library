...
<diff>
  <diff-added>
    <cib>
      <configuration>
        <resources>
          <clone __crm_diff_marker__='added:top' id='clone-my_resource'>
            ...
            <primitive __crm_diff_marker__='added:top' class='ocf' id='my_resource' provider='pacemaker' type='Dummy'>
...
<diff>
  <diff-added>
    <cib>
      <configuration>
        <resources>
          <master __crm_diff_marker__='added:top' id='master-p_rabbitmq-server'>
