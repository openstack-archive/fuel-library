...
class openstack::controller (
  ...
  if $network_provider == 'neutron' {
    ...
    if $primary_controller {
      ...
      Class['openstack::keystone'] -> Class['openstack::network']

      Class['openstack::keystone'] ->
      Keystone_user <| title ==  'neutron' |> ->
      ...
      Service <| title == 'neutron-server'|> ->
        Openstack::Ha::Haproxy_service <| title == 'keystone' |> ->
          Openstack::Ha::Haproxy_service <| title == 'neutron' |> ->
