...
class openstack::ceilometer (
  ...
  if ($ceilometer_vcenter_host_ip) {
    ceilometer_config {
      ...
      'vmware/ceilometer_vcenter_user'     : value => $ceilometer_vcenter_user;
      'vmware/ceilometer_vcenter_password' : value => $ceilometer_vcenter_password;
      'vmware/ceilometer_vcenter_host_ip'  : value => $ceilometer_vcenter_host_ip;
    }
