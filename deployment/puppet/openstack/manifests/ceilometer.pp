...
class openstack::ceilometer (
  ...
  if ($ceilometer_vcenter_host_ip) {
    ceilometer_config {
      ...
      'DEFAULT/default_log_levels'   : value => 'amqp=WARN,amqplib=WARN,boto=WARN,qpid=WARN,\
sqlalchemy=WARN,suds=INFO,iso8601=WARN,requests.packages.urllib3.connectionpool=WARN,oslo.vmware=WARN';
