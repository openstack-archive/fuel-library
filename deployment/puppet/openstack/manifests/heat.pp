...
class openstack::heat (
  ...
  # TODO(bogdando) clarify this obsolete config section (upstream presync state)
  heat_config {
  ...
  class { 'heat::keystone::auth' :
    ...
    region                         => 'RegionOne',
    tenant                         => 'services',
    email                          => "${keystone_user}@mirantis.com",
  ...
  class { 'heat::keystone::auth_cfn' :
    ...
    region                         => 'RegionOne',
    tenant                         => 'services',
    email                          => "${keystone_user}-cfn@mirantis.com",
    public_protocol                => 'http',
    admin_protocol                 => 'http',
    internal_protocol              => 'http',
    configure_endpoint             => true,
