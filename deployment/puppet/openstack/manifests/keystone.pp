...
# [revoke_by_id] Revoke token by token identifier. Setting revoke_by_id to true enables various forms of enumerating tokens.
#
# === Example
#
# class { 'openstack::keystone':
...
class openstack::keystone (
  ...
  if $enabled {
    ...
    if $memcache_servers or $cache_memcache_servers {
