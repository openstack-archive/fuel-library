...
class openstack::keystone (
  ...
  # Because autorequire in type definition fails to enforce this
  Service<| title == 'keystone' |> -> Keystone_tenant <| |>
  Service<| title == 'keystone' |> -> Keystone_user <| |>
  Service<| title == 'keystone' |> -> Keystone_role <| |>
  Service<| title == 'keystone' |> -> Keystone_user_role <| |>
  Service<| title == 'keystone' |> -> Keystone_service <| |>
  Service<| title == 'keystone' |> -> Keystone_endpoint <| |>
