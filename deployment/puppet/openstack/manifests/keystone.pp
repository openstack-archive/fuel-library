...
#FIXME nkoshikov
#This  section needs to be fixed to not overwriting values if file exist
#or maybe change the way - providers expect admin_token
...
#    # it later.
#
#    if !($enabled) and ($glance or $nova or $cinder or $neutron or $ceilometer)
#    {
