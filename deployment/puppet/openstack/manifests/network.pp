  ...
  )
{
  ...
  # Collect value to ensure any conflicting defines are found first
  # if this doesn't work, then we should make nova::network run first
  Sysctl::Value<|title = 'net.ipv4.ip_forward'> ->
