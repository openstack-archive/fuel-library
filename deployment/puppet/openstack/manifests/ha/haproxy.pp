...
class openstack::ha::haproxy (
  ...
  if !$disable_hash[disable_horizon] {
  ...
  if !$disable_hash[disable_keystone] {
  ...
  if !$disable_hash[disable_glance] {
  ...
  if !$disable_hash[disable_cinder] {
  ...
  if $neutron and !$disable_hash[disable_cinder] {
  ...
  if ($custom_mysql_setup_class == 'galera' or $custom_mysql_setup_class == 'percona') and !$disable_hash[disable_mysqld] {
  ...
  if $swift_proxies and !$disable_hash[disable_swift_proxies] {
  ...
  if $rgw_servers and !$disable_hash[disable_rgw_servers] {
  ...
  if $ceilometer and !$disable_hash[disable_ceilometer] {
  ...
  if $sahara and !$disable_hash[disable_sahara] {
  ...
  if $murano and !$disable_hash[disable_murano] {
