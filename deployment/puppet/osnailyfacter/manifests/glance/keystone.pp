class osnailyfacter::glance::keystone {
  ...
  $glare_public_url = "${public_protocol}://${public_address}:9494"
  $glare_internal_url = "${internal_protocol}://${internal_address}:9494"
  $glare_admin_url  = "${admin_protocol}://${admin_address}:9494"
