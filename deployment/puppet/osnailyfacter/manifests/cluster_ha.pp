  ...
  case $::fuel_settings['role'] {
    /controller/ : {
      ...
      if ($use_swift) {
        ...
        Package<| title == $::glance::params::api_package_name |> -> Swift::Storage::All::Device_directory <| |>
        Package<| title == $::glance::params::api_package_name |> -> File <| title == $swift_partition |>
