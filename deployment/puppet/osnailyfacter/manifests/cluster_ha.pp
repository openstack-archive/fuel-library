class osnailyfacter::cluster_ha {
  ...
  class compact_controller (
    ...
    class { 'openstack::controller_ha':
      ...
      internal_address              => $::osnailyfacter::cluster_ha::internal_address,
      ...
      debug                         => $::osnailyfacter::cluster_ha::debug ? { 'true'=>true, true=>true, default=>false },
      verbose                       => $::osnailyfacter::cluster_ha::verbose ? { 'true'=>true, true=>true, default=>false },
      queue_provider                => $::queue_provider,
      qpid_password                 => $::osnailyfacter::cluster_ha::rabbit_hash[password],
      qpid_user                     => $::osnailyfacter::cluster_ha::rabbit_hash[user],
      ...
      rabbit_password               => $::osnailyfacter::cluster_ha::rabbit_hash[password],
      rabbit_user                   => $::osnailyfacter::cluster_ha::rabbit_hash[user],
      rabbit_nodes                  => $::osnailyfacter::cluster_ha::controller_hostnames,
      ...
      rgw_balancers                 => $::osnailyfacter::cluster_ha::rgw_balancers,
      quantum                       => $::use_quantum,
      ...
      custom_mysql_setup_class      => $::osnailyfacter::cluster_ha::custom_mysql_setup_class,
      mysql_skip_name_resolve       => true,
      use_syslog                    => $::fuel_settings['use_syslog'] ? { 'false'=>false, false=>false, default=>true },
      syslog_log_level              => $::osnailyfacter::cluster_ha::syslog_log_level,
      syslog_log_facility_glance    => $::osnailyfacter::cluster_ha::syslog_log_facility_glance,
      syslog_log_facility_cinder    => $::osnailyfacter::cluster_ha::syslog_log_facility_cinder,
      syslog_log_facility_neutron   => $::osnailyfacter::cluster_ha::syslog_log_facility_neutron,
      syslog_log_facility_nova      => $::osnailyfacter::cluster_ha::syslog_log_facility_nova,
      syslog_log_facility_keystone  => $::osnailyfacter::cluster_ha::syslog_log_facility_keystone,
      nova_rate_limits              => $::osnailyfacter::cluster_ha::nova_rate_limits,
      cinder_rate_limits            => $::osnailyfacter::cluster_ha::cinder_rate_limits,
