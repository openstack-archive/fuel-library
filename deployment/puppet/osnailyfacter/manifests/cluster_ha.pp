class osnailyfacter::cluster_ha {
  ...
  class compact_controller (
    ...
    class { 'openstack::controller_ha':
      ...
      ceilometer_vcenter_user        => $::osnailyfacter::cluster_ha::vcenter_hash['vc_user'],
      ceilometer_vcenter_password    => $::osnailyfacter::cluster_ha::vcenter_hash['vc_password'],
      ceilometer_vcenter_host_ip     => $::osnailyfacter::cluster_ha::vcenter_hash['host_ip'],
