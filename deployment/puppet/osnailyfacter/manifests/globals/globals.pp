class osnailyfacter::globals::globals {
  ...
  $public_vip             = try_get_value($network_metadata,
                              'vips/public/ipaddr', get_network_role_property('public/vip', 'ipaddr')
                            )
  $management_vip         = try_get_value($network_metadata,
                              'vips/management/ipaddr', get_network_role_property('mgmt/vip', 'ipaddr')
                            )
  $public_vrouter_vip     = try_get_value($network_metadata, 'vips/vrouter_pub/ipaddr', undef)
  $management_vrouter_vip = try_get_value($network_metadata, 'vips/vrouter/ipaddr', undef)
