class osnailyfacter::globals::globals {
  ...
  # $node_name is a short name (e.g. hostname) from fqdn of node_hash.
  # It may be changed while LCM and not the same, than immutable $node_key_name
  # (generated by the get_node_key_name() custom puppet function)
  $node_name = $node_hash['name']
