class osnailyfacter::globals::globals {
  ...
  $keystone_tagged_nodes = get_nodes_hash_by_tags($network_metadata, ['primary-modular-keystone', 'modular-keystone'])
  ...
  $corosync_tags = hiera('corosync_tags', ['primary-controller', 'controller',
                                           'primary-modular-rabbitmq', 'modular-rabbitmq',
                                           'primary-modular-database', 'modular-database',
                                           'primary-modular-neutron', 'modular-neutron'])
