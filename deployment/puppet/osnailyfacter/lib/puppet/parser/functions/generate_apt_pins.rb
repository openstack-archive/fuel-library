...
module Puppet::Parser::Functions
  newfunction(:generate_apt_pinning, :type => :rvalue) do |args|
    raise(Puppet::ParseError, "generate_apt_pinning.(): Wrong number of " +
          "arguments given (#{args.size}, expected 1)") if args.size != 1

    repositories = args[0]

    raise(Puppet::ParseError, "generate_apt_pinning.(): Requires array to " +
