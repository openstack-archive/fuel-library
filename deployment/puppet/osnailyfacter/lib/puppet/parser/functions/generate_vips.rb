  ...
  newfunction(:generate_vips) do |args|
    ...
    vips.each do |name, parameters|
      ...
      if parameters['namespace']
        ...
        debug "Skipping vip: '#{name}' because the 'namespace' parameter is not defined! Such VIPs doesn't managed by Pacemaker and should be handled by plugin completely."
        next
      end
