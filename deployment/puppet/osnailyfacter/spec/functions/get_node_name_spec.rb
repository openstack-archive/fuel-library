...
describe 'the get_node_name function' do
  let(:scope) { PuppetlabsSpec::PuppetInternals.scope }

  it 'should exist' do
    expect(
        Puppet::Parser::Functions.function('get_node_name')
    ).to eq('function_get_node_name')
  end
  ...
  it 'should be able to find a node_name for long name' do
    ...
    expect(scope.function_get_node_name []).to eq 'qwe'
  end
  ...
  it 'should be able to find a node_name for long name' do
    ...
    expect(scope.function_get_node_name []).to eq 'lll'
  end
