  ...
  context 'when both hashes is empty' do
    ...
    context 'for non-public endpoints' do
      it 'should get data from default values for non-public endpoints' do
        ...
        is_expected.to run.with_params({}, {}, 'keystone', 'internal', 'hostname', ['keystone.fuel.local']).and_return('keystone.fuel.local')
        is_expected.to run.with_params({}, {}, 'keystone', 'internal', 'path', '/var/lib/somewhere').and_return('/var/lib/somewhere')
        ...
        is_expected.to run.with_params({}, {}, 'keystone', 'admin', 'hostname', ['keystone.fuel.local']).and_return('keystone.fuel.local')
        is_expected.to run.with_params({}, {}, 'keystone', 'admin', 'path', '/var/lib/somewhere').and_return('/var/lib/somewhere')
