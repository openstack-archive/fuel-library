...
defaults:
  ...
  it 'should accept a resource type into types_create' do
    type = 'keystone_config'
    override_resources[:types_create] = type
    expect(override_resources[:types_create]).to eq(type)
  end
  ...
  it 'should accept a resource title into titles_create' do
    title = 'bar'
    override_resources[:titles_create] = title
    expect(override_resources[:titles_create]).to eq(title)
  end
