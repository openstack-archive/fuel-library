...
$public_nets  = get_routable_networks_for_network_role($network_scheme, 'public/vip')
$management_nets = get_routable_networks_for_network_role($network_scheme, 'mgmt/vip')
#todo (sv): convert 'starage' to more specific network role
...
anchor {'end_main_firewall_rules':}
...
if $ironic_hash['enabled'] {
  ...
  firewall {'00 baremetal-filter':
    ...
    jump    => 'baremetal',
    require => Anchor['end_main_firewall_rules'],
  }
