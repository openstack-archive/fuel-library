...
$neutron_db_pass      = hiera('neutron_db_password', false)
...
$neutron_db_user        = $neutron_hash['db_user'] ? {
   default  => $neutron_hash['db_user'],
   undef    => 'neutron',
}
$neutron_db_dbname      = $neutron_hash['db_name'] ? {
   default  => $neutron_hash['db_name'],
   undef    => 'neutron',
}
$neutron_db_password    = $neutron_hash['db_password'] ? {
   default  => $neutron_hash['db_password'],
   undef    => $neutron_db_pass,
}
