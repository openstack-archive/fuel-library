...
$mysql_database_password  = pick($mysql_hash, 'root_password')
$mysql_database_enabled   = pick($mysql_hash, 'enabled', true)
$mysql_account_security   = pick($mysql_hash, 'db_secure', true)
...
$status_password          = pick($mysql_hash, 'wsrep_password')
$backend_port             = '3307'
$backend_timeout          = '10'

$management_interface     = pick($network_scheme, 'roles/management')
$management_network       = pick($network_scheme, "endpoints/${management_interface}/IP")
