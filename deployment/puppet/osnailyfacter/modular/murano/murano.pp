...
if $murano_hash['enabled'] {
  ...
  # TODO (iberezovskiy): switch on murano::logging class after murano module update
  # https://github.com/openstack/puppet-murano/blob/master/manifests/logging.pp#L190-L199
