...
$auth_user          = $nova_hash['user']
$auth_password      = $nova_hash['user_password']
$auth_tenant        = $nova_hash['tenant']
...
class { 'neutron::server::notifications':
  ...
  nova_admin_username     => $auth_user,
  nova_admin_tenant_name  => $auth_tenant,
  nova_admin_password     => $auth_password,
