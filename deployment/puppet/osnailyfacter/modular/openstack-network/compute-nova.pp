...
if $use_neutron {
  ...
  # TODO(aschultz): Just use $::nova::params::libvirt_service_name instead when
  # a version of puppet-nova has been pulled in that uses os_package_type to
  # correctly handle the debian package name.
