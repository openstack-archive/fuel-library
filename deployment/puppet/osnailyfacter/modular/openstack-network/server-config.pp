...
if $use_neutron {
  ...
  $mechanism_drivers         = delete(try_get_value($neutron_config, 'L2/mechanism_drivers', concat($default_mechanism_drivers,$l2_population_mech_driver,$sriov_mechanism_driver)), "")
  $flat_networks             = ['*']
