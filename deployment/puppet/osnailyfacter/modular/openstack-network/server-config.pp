...
if $use_neutron {
  ...
  $internal_auth_endpoint  = ssl($ssl_hash, {}, 'keystone', 'internal', 'hostname', [hiera('keystone_endpoint', ''), $service_endpoint, $management_vip])

  $admin_auth_protocol     = ssl($ssl_hash, {}, 'keystone', 'admin', 'protocol', 'http')
  $admin_auth_endpoint     = ssl($ssl_hash, {}, 'keystone', 'admin', 'hostname', [hiera('keystone_endpoint', ''), $service_endpoint, $management_vip])

  $nova_internal_protocol  = ssl($ssl_hash, {}, 'nova', 'internal', 'protocol', 'http')
  $nova_internal_endpoint  = ssl($ssl_hash, {}, 'nova', 'internal', 'hostname', [$nova_endpoint, $management_vip])
