...
$public_protocol     = ssl($ssl_hash, $public_ssl_hash, 'neutron', 'public', 'protocol', 'http')
$public_address      = ssl($ssl_hash, $public_ssl_hash, 'neutron', 'public', 'hostname', [$public_vip])

$internal_protocol   = ssl($ssl_hash, {}, 'neutron', 'internal', 'protocol', 'http')
$internal_address    = ssl($ssl_hash, {}, 'neutron', 'internal', 'hostname', [$management_vip])

$admin_protocol      = ssl($ssl_hash, {}, 'neutron', 'admin', 'protocol', 'http')
$admin_address       = ssl($ssl_hash, {}, 'neutron', 'admin', 'hostname', [$management_vip])
