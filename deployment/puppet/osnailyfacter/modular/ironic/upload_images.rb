...
{"os_name"=>"ironic-deploy-linux",
 "img_location"=>"/var/lib/astute/ironic-bootstrap/linux",
...
{"os_name"=>"ironic-deploy-initramfs",
 "img_location"=>"/var/lib/astute/ironic-bootstrap/initramfs.img",
...
{"os_name"=>"ironic-deploy-squashfs",
 "img_location"=>"/var/lib/astute/ironic-bootstrap/root.squashfs",
 "container_format"=>"ari",
 "min_ram"=>2048,
 "disk_format"=>"ari",
 "glance_properties"=>"",
