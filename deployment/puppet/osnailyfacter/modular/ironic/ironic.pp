...
# TODO (iberezovskiy): switch on ironic::logging class after ironic module update
# https://github.com/openstack/puppet-ironic/blob/master/manifests/logging.pp#L189-L199
