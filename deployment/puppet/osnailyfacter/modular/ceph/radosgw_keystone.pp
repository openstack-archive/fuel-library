...
if $storage_hash['objects_ceph'] {
  ...
  $internal_address  = get_ssl_property($ssl_hash, {}, 'radosgw', 'internal', 'hostname', [hiera('radosgw_endpoint', ''), $management_vip])

  $admin_protocol    = get_ssl_property($ssl_hash, {}, 'radosgw', 'admin', 'protocol', 'http')
  $admin_address     = get_ssl_property($ssl_hash, {}, 'radosgw', 'admin', 'hostname', [hiera('radosgw_endpoint', ''), $management_vip])
