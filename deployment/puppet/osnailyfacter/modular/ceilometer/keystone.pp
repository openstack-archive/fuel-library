...
$public_protocol = ssl($ssl_hash, $public_ssl_hash, 'ceilometer', 'public', 'protocol', 'http')
$public_address  = ssl($ssl_hash, $public_ssl_hash, 'ceilometer', 'public', 'hostname', [$public_vip])

$internal_protocol = ssl($ssl_hash, {}, 'ceilometer', 'internal', 'protocol', 'http')
$internal_address  = ssl($ssl_hash, {}, 'ceilometer', 'internal', 'hostname', [$management_vip])

$admin_protocol = ssl($ssl_hash, {}, 'ceilometer', 'admin', 'protocol', 'http')
$admin_address  = ssl($ssl_hash, {}, 'ceilometer', 'admin', 'hostname', [$management_vip])
