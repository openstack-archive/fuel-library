...
$db_host                        = $nova_hash['db_host'] ? {
  default => $nova_hash['db_host'],
...
$keystone_user                  = $nova_hash['user'] ? {
  default => $nova_hash['user'],
  undef   => 'nova',
}
$keystone_tenant                = $nova_hash['tenant'] ? {
  default => $nova_hash['tenant'],
  undef   => 'services',
}
