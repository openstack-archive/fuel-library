...
$keystone_endpoint          = get_ssl_property($ssl_hash, {}, 'keystone', 'internal', 'hostname', [hiera('keystone_endpoint', ''), hiera('service_endpoint', ''), $management_vip])

$swift_internal_protocol    = get_ssl_property($ssl_hash, {}, 'swift', 'internal', 'protocol', 'http')
$swift_internal_endpoint    = get_ssl_property($ssl_hash, {}, 'swift', 'internal', 'hostname', [$management_vip])
