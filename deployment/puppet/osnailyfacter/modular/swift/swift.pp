...
$keystone_internal_protocol = ssl($ssl_hash, {}, 'keystone', 'internal', 'protocol', 'http')
$keystone_endpoint          = ssl($ssl_hash, {}, 'keystone', 'internal', 'hostname', [hiera('keystone_endpoint', ''), hiera('service_endpoint', ''), $management_vip])

$swift_internal_protocol    = ssl($ssl_hash, {}, 'swift', 'internal', 'protocol', 'http')
$swift_internal_endpoint    = ssl($ssl_hash, {}, 'swift', 'internal', 'hostname', [$swift_api_ipaddr, $management_vip])
