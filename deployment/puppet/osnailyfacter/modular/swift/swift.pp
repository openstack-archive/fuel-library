include ::openstack_tasks::swift::swift
...
class memcached {}
include memcached
warning('osnailyfacter/modular/./swift/swift.pp is deprecated in mitaka and will be removed in newton. Please use openstack_tasks/examples/./swift/swift.pp')
