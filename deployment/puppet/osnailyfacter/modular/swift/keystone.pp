...
if try_get_value($swift_hash, 'public_vip', false) {
  $public_address = $swift_hash['public_vip']
  $public_protocol = 'http'
} elsif $public_ssl_hash['services'] or try_get_value($ssl_hash, 'swift_public', false) {
  $public_address = pick(try_get_value($ssl_hash, 'swift_public_hostname', ''), $public_ssl_hash['hostname'], $public_vip)
