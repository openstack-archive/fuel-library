...
$public_protocol    = ssl($ssl_hash, $public_ssl_hash, 'swift', 'public', 'protocol', 'http')
$public_address     = ssl($ssl_hash, $public_ssl_hash, 'swift', 'public', 'hostname', [$swift_hash['public_vip'], $public_vip])

$internal_protocol  = ssl($ssl_hash, {}, 'swift', 'internal', 'protocol', 'http')
$internal_address   = ssl($ssl_hash, {}, 'swift', 'internal', 'hostname', [$management_vip])
