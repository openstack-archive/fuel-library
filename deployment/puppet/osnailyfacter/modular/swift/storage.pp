...
#
warning('osnailyfacter/modular/./swift/storage.pp is deprecated in mitaka and will be removed in newton. Please use openstack_tasks/examples/./swift/storage.pp')
