...
# NOTE(bogdando) for nodes with Corosync/Pacemaker we delegate
#   all of the monitor functions to RA instead of monit.
#   A custom fact 'pacemaker_hostname' will help to determine such cases.

if ($use_monit and $::pacemaker_hostname=='') {
