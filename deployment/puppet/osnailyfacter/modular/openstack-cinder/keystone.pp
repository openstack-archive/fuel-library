...
$public_protocol     = ssl($ssl_hash, $public_ssl_hash, 'cinder', 'public', 'protocol', 'http')
$public_address      = ssl($ssl_hash, $public_ssl_hash, 'cinder', 'public', 'hostname', [$public_vip])

$internal_protocol   = ssl($ssl_hash, {}, 'cinder', 'internal', 'protocol', 'http')
$internal_address    = ssl($ssl_hash, {}, 'cinder', 'internal', 'hostname', [$management_vip])

$admin_protocol      = ssl($ssl_hash, {}, 'cinder', 'admin', 'protocol', 'http')
$admin_address       = ssl($ssl_hash, {}, 'cinder', 'admin', 'hostname', [$management_vip])
