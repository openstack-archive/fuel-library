...
$db_password = pick($glance_hash, 'db_password')

$db_host       = pick($glance_hash, 'db_host', $mysql_db_host)
$db_create     = pick($glance_hash, 'db_create', $mysql_db_create)
$root_user     = pick($glance_hash, 'root_user', $mysql_root_user)
$root_password = pick($glance_hash, 'root_password', $mysql_root_password)
