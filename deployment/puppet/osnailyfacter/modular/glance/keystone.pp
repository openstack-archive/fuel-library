...
$public_protocol     = ssl($ssl_hash, $public_ssl_hash, 'glance', 'public', 'protocol', 'http')
$public_address      = ssl($ssl_hash, $public_ssl_hash, 'glance', 'public', 'hostname', [$public_vip])
$internal_protocol   = ssl($ssl_hash, {}, 'glance', 'internal', 'protocol', 'http')
$internal_address    = ssl($ssl_hash, {}, 'glance', 'internal', 'hostname', [$management_vip])
$admin_protocol      = ssl($ssl_hash, {}, 'glance', 'admin', 'protocol', 'http')
$admin_address       = ssl($ssl_hash, {}, 'glance', 'admin', 'hostname', [$management_vip])
