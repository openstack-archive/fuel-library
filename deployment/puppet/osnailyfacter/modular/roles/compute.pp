...
$glance_internal_ssl            = ssl($ssl_hash, {}, 'glance', 'internal', 'usage', false)
...
$vncproxy_protocol                      = ssl($ssl_hash, $public_ssl_hash, 'nova', 'public', 'protocol', [$nova_hash['vncproxy_protocol'], 'http'])
$vncproxy_host                          = ssl($ssl_hash, $public_ssl_hash, 'nova', 'public', 'hostname', [$public_vip])
