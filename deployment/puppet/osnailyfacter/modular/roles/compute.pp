...
$glance_internal_ssl            = get_ssl_property($ssl, {}, 'glance', 'internal', 'usage', false)
...
$vncproxy_protocol                      = get_ssl_property($ssl, $public_ssl_hash, 'nova', 'public', 'protocol', [$nova_hash['vncproxy_protocol'], 'http'])
$vncproxy_host                          = get_ssl_property($ssl, $public_ssl_hash, 'nova', 'public', 'hostname', [$public_vip])
...
$nova_complete_hash = merge($nova_config, $nova_custom_hash)
