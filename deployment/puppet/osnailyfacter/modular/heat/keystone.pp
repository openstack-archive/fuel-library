...
$public_protocol   = ssl($ssl_hash, $public_ssl_hash, 'heat', 'public', 'protocol', 'http')
$public_address    = ssl($ssl_hash, $public_ssl_hash, 'heat', 'public', 'hostname', [$public_vip])

$internal_protocol = ssl($ssl_hash, {}, 'heat', 'internal', 'protocol', 'http')
$internal_address  = ssl($ssl_hash, {}, 'heat', 'internal', 'hostname', [hiera('heat_endpoint', ''), $management_vip])

$admin_protocol    = ssl($ssl_hash, {}, 'heat', 'admin', 'protocol', 'http')
$admin_address     = ssl($ssl_hash, {}, 'heat', 'admin', 'hostname', [hiera('heat_endpoint', ''), $management_vip])
