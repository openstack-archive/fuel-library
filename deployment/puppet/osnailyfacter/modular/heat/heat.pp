...
$public_auth_protocol     = ssl($ssl_hash, $public_ssl_hash, 'keystone', 'public', 'protocol', 'http')
$public_auth_address      = ssl($ssl_hash, $public_ssl_hash, 'keystone', 'public', 'hostname', [$public_vip])
...
$admin_auth_protocol      = ssl($ssl_hash, {}, 'keystone', 'admin', 'protocol', 'http')
$admin_auth_address       = ssl($ssl_hash, {}, 'keystone', 'admin', 'hostname', [hiera('keystone_endpoint', ''), $service_endpoint, $management_vip])

$heat_protocol            = ssl($ssl_hash, {}, 'heat', 'internal', 'protocol', 'http')
$heat_endpoint            = ssl($ssl_hash, {}, 'heat', 'internal', 'hostname', [hiera('heat_endpoint', ''), $management_vip])
$internal_ssl             = ssl($ssl_hash, {}, 'heat', 'internal', 'usage', false)

$public_ssl               = ssl($ssl_hash, {}, 'heat', 'public', 'usage', false)
