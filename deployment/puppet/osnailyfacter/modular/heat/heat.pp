...
$public_auth_address      = get_ssl_property($ssl, $public_ssl_hash, 'keystone', 'public', 'hostname', [$public_vip])
...
$heat_protocol            = get_ssl_property($ssl, {}, 'heat', 'internal', 'protocol', 'http')
$heat_endpoint            = get_ssl_property($ssl, {}, 'heat', 'internal', 'hostname', [hiera('heat_endpoint', ''), $management_vip])
$internal_ssl             = get_ssl_property($ssl, {}, 'heat', 'internal', 'usage', false)

$public_ssl               = get_ssl_property($ssl, {}, 'heat', 'public', 'usage', false)
