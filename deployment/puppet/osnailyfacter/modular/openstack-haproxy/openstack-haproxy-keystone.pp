...
$public_ssl            = ssl($ssl_hash, $public_ssl_hash, 'keystone', 'public', 'usage', false)
$public_ssl_path       = ssl($ssl_hash, $public_ssl_hash, 'keystone', 'public', 'path', [''])

$internal_ssl          = ssl($ssl_hash, {}, 'keystone', 'internal', 'usage', false)
$internal_ssl_path     = ssl($ssl_hash, {}, 'keystone', 'internal', 'path', [''])

$admin_ssl             = ssl($ssl_hash, {}, 'keystone', 'admin', 'usage', false)
$admin_ssl_path        = ssl($ssl_hash, {}, 'keystone', 'admin', 'path', [''])
