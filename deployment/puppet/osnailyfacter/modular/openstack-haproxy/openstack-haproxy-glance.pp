...
$public_ssl        = ssl($ssl_hash, $public_ssl_hash, 'glance', 'public', 'usage', false)
$public_ssl_path   = ssl($ssl_hash, $public_ssl_hash, 'glance', 'public', 'path', [''])

$internal_ssl      = ssl($ssl_hash, {}, 'glance', 'internal', 'usage', false)
$internal_ssl_path = ssl($ssl_hash, {}, 'glance', 'internal', 'path', [''])
