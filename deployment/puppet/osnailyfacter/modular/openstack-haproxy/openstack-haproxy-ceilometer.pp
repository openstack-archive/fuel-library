...
$public_ssl              = ssl($ssl_hash, $public_ssl_hash, 'ceilometer', 'public', 'usage', false)
$public_ssl_path         = ssl($ssl_hash, $public_ssl_hash, 'ceilometer', 'public', 'path', [''])

$internal_ssl            = ssl($ssl_hash, {}, 'ceilometer', 'internal', 'usage', false)
$internal_ssl_path       = ssl($ssl_hash, {}, 'ceilometer', 'internal', 'path', [''])
