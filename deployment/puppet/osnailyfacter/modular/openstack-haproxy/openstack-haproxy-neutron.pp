...
$public_ssl          = ssl($ssl_hash, $public_ssl_hash, 'neutron', 'public', 'usage', false)
$public_ssl_path     = ssl($ssl_hash, $public_ssl_hash, 'neutron', 'public', 'path', [''])

$internal_ssl        = ssl($ssl_hash, {}, 'neutron', 'internal', 'usage', false)
$internal_ssl_path   = ssl($ssl_hash, {}, 'neutron', 'internal', 'path', [''])
