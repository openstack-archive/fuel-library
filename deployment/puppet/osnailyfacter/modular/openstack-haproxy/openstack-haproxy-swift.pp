...
$public_ssl        = ssl($ssl_hash, $public_ssl_hash, 'swift', 'public', 'usage', false)
$public_ssl_path   = ssl($ssl_hash, $public_ssl_hash, 'swift', 'public', 'path', [''])

$internal_ssl      = ssl($ssl_hash, {}, 'swift', 'internal', 'usage', false)
$internal_ssl_path = ssl($ssl_hash, {}, 'swift', 'internal', 'path', [''])
