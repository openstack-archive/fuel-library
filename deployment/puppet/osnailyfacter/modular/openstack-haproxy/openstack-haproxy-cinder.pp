...
$public_ssl         = ssl($ssl_hash, $public_ssl_hash, 'cinder', 'public', 'usage', false)
$public_ssl_path    = ssl($ssl_hash, $public_ssl_hash, 'cinder', 'public', 'path', [''])

$internal_ssl       = ssl($ssl_hash, {}, 'cinder', 'internal', 'usage', false)
$internal_ssl_path  = ssl($ssl_hash, {}, 'cinder', 'internal', 'path', [''])
