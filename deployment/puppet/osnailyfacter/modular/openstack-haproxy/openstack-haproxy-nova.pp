...
$public_ssl           = ssl($ssl_hash, $public_ssl_hash, 'nova', 'public', 'usage', false)
$public_ssl_path      = ssl($ssl_hash, $public_ssl_hash, 'nova', 'public', 'path', [''])

$internal_ssl         = ssl($ssl_hash, {}, 'nova', 'internal', 'usage', false)
$internal_ssl_path    = ssl($ssl_hash, {}, 'nova', 'internal', 'path', [''])
