...
$public_ssl         = ssl($ssl_hash, $public_ssl_hash, 'sahara', 'public', 'usage', false)
$public_ssl_path    = ssl($ssl_hash, $public_ssl_hash, 'sahara', 'public', 'path', [''])

$internal_ssl       = ssl($ssl_hash, {}, 'sahara', 'internal', 'usage', false)
$internal_ssl_path  = ssl($ssl_hash, {}, 'sahara', 'internal', 'path', [''])
