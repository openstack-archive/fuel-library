...
$public_ssl        = get_ssl_property($ssl, $public_ssl_hash, 'heat', 'public', 'usage', false)
$public_ssl_path   = get_ssl_property($ssl, $public_ssl_hash, 'heat', 'public', 'path', [''])

$internal_ssl      = get_ssl_property($ssl, {}, 'heat', 'internal', 'usage', false)
$internal_ssl_path = get_ssl_property($ssl, {}, 'heat', 'internal', 'path', [''])
