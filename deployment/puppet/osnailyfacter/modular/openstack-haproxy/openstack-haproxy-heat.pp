...
$public_ssl        = ssl($ssl_hash, $public_ssl_hash, 'heat', 'public', 'usage', false)
$public_ssl_path   = ssl($ssl_hash, $public_ssl_hash, 'heat', 'public', 'path', [''])

$internal_ssl      = ssl($ssl_hash, {}, 'heat', 'internal', 'usage', false)
$internal_ssl_path = ssl($ssl_hash, {}, 'heat', 'internal', 'path', [''])
