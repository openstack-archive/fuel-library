...
if is_hash($network_metadata['vips']['public_vip']) {
  $public_vip                  = $network_metadata['vips']['public_vip']['ipaddr']
} else {
  $public_vip                  = $network_metadata['vips']['public_vip']
}
if is_hash($network_metadata['vips']['management_vip']) {
  $management_vip                  = $network_metadata['vips']['management_vip']['ipaddr']
} else {
...
if is_hash($network_metadata['vips']['public_vrouter_vip']) {
  $public_vrouter_vip          = $network_metadata['vips']['public_vrouter_vip']['ipaddr']
} else {
  $public_vrouter_vip          = $network_metadata['vips']['public_vrouter_vip']
}
if is_hash($network_metadata['vips']['management_vrouter_vip']) {
  $management_vrouter_vip      = $network_metadata['vips']['management_vrouter_vip']['ipaddr']
} else {
