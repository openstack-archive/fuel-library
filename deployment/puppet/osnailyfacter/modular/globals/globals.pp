...
if !$ceilometer_hash['alarm_history_time_to_live'] {
  $real_ceilometer_hash = merge($ceilometer_hash, { 'alarm_history_time_to_live' => '604800' })
}
if !$ceilometer_hash['event_time_to_live'] {
  $real_ceilometer_hash = merge($ceilometer_hash, { 'event_time_to_live' => '604800' })
}
if !$ceilometer_hash['metering_time_to_live'] {
  $real_ceilometer_hash = merge($ceilometer_hash, { 'metering_time_to_live' => '604800' })
}
if !$ceilometer_hash['http_timeout'] {
  $real_ceilometer_hash = merge($ceilometer_hash, { 'http_timeout' => '600' })
}
