...
if !$ceilometer_hiera_hash['event_time_to_live'] {
  $ceilometer_event_time_to_live = '604800'
}

if !$ceilometer_hiera_hash['metering_time_to_live'] {
  $ceilometer_metering_time_to_live = '604800'
}

if !$ceilometer_hiera_hash['http_timeout'] {
