...
if !$ceilometer_hash['alarm_history_time_to_live'] {
  $ceilometer_alarm_history_time_to_live = { 'alarm_history_time_to_live' => '604800' }
} else {
  $ceilometer_alarm_history_time_to_live = {}
}
if !$ceilometer_hash['event_time_to_live'] {
  $ceilometer_event_time_to_live = { 'event_time_to_live' => '604800' }
} else {
  $ceilometer_event_time_to_live = {}
}
if !$ceilometer_hash['metering_time_to_live'] {
  $ceilometer_metering_time_to_live = { 'metering_time_to_live' => '604800' }
} else {
  $ceilometer_metering_time_to_live = {}
}
if !$ceilometer_hash['http_timeout'] {
  $ceilometer_http_timeout = { 'http_timeout' => '600' }
} else {
  $ceilometer_http_timeout = {}
}
$real_ceilometer_hash = merge($ceilometer_hash,
                              $ceilometer_alarm_history_time_to_live,
                              $ceilometer_event_time_to_live,
                              $ceilometer_metering_time_to_live,
                              $ceilometer_http_timeout)
