...
Service['httpd'] -> Exec ['minute_sleep']
Exec ['minute_sleep'] -> Haproxy_backend_status <||>
Haproxy_backend_status<||> -> Keystone_domain <||>
Haproxy_backend_status<||> -> Keystone_endpoint <||>
Haproxy_backend_status<||> -> Keystone_role <||>
Haproxy_backend_status<||> -> Keystone_service <||>
Haproxy_backend_status<||> -> Keystone_tenant <||>
Haproxy_backend_status<||> -> Keystone_user <||>
Haproxy_backend_status<||> -> Keystone_user_role <||>
