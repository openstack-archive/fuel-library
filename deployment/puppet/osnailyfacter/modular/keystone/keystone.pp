...
osnailyfacter::auth_file { '/root/openrc':
...
osnailyfacter::auth_file { "${operator_user_homedir}/openrc":
  admin_user          => $admin_user,
  admin_password      => $admin_password,
  admin_tenant        => $admin_tenant,
  region_name         => $region,
...
osnailyfacter::auth_file { "${service_user_homedir}/openrc":
  admin_user          => $admin_user,
  admin_password      => $admin_password,
  admin_tenant        => $admin_tenant,
  region_name         => $region,
