...
$db_type     = 'mysql'
$db_host     = pick($keystone_hash['db_host'], $internal_address)
...
$admin_url = "http://${internal_address}:${admin_port}"
...
class { 'openstack::keystone':
  ...
  internal_address      => $internal_address, # send traffic through HAProxy
