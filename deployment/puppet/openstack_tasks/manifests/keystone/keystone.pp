class openstack_tasks::keystone::keystone {
  ...
  if ("${operator_user_homedir}/openrc" != "/root/openrc") and 
     ("${operator_user_homedir}/openrc" != "${service_user_homedir}/openrc") {
  ...
  if ("${service_user_homedir}/openrc" != "/root/openrc") and
     ("${service_user_homedir}/openrc" != "${operator_user_homedir}/openrc") {
