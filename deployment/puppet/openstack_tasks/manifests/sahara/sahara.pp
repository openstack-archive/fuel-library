class openstack_tasks::sahara::sahara {
  ...
  if $sahara_hash['enabled'] {
    ...
    class { '::sahara' :
      ...
      # TODO(aschultz): https://review.openstack.org/336290
      #memcached_servers      => $memcached_servers,
    }

    # TODO(aschultz): remove this and switch to the sahara param
    ensure_resource('sahara_config', 'keystone_authtoken/memcached_servers', {
      ensure => present,
