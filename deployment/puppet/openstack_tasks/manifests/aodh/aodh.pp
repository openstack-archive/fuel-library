class openstack_tasks::aodh::aodh {
  ...
  class { '::aodh::api':
    ...
    # TODO(aschultz): https://review.openstack.org/#/c/336101/
    #memcached_servers => $memcached_servers,
  }

  # TODO(aschultz): remove this and switch to the aodh::api param
  ensure_resource('aodh_config', 'keystone_authtoken/memcached_servers', {
    ensure => present,
