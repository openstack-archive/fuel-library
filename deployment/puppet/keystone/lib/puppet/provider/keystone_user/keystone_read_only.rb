...
Puppet::Type.type(:keystone_user).provide(
  ...
  def create
    warn "Create this user manually!"
  end
  ...
  def destroy
    warn "Remove this user manually!"
  end
  ...
  def enabled=(value)
    warn "Enable or disable this user manually!"
  end
  ...
  def password=(value)
    warn "Set password for this user manually!"
  end
  ...
  def email=(value)
    warn "Set email for this user manually!"
  end
