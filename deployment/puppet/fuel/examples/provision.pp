...
# FIXME(kozhukalov): Implement multicluster support
$provision_data = loadyaml('/tmp/provision.yaml', $default_provision_data)
$known_hosts = $provision_data['network_metadata']['nodes']
