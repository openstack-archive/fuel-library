class fuel::keystone (
  ...
  keystone_tenant { 'admin':
    ...
    require => Keystone_Domain['admin_project_domain']
  }

  keystone_domain { 'services_user_domain':
    ensure => present,
    enabled => true,
  }

  keystone_domain { 'services_project_domain':
    ensure => present,
    enabled => true,
  }
  ...
  keystone_tenant { 'services':
    ...
    domain      => 'services_project_domain',
    require     => Keystone_Domain['services_project_domain'],
  }
  ...
  keystone_user { $admin_user :
    ...
    require         => Keystone_Domain['admin_user_domain'],
  }
  ...
  keystone_user_role { "${admin_user}@admin":
    ...
    require        => [Keystone_Domain[['admin_user_domain', 'admin_project_domain']],
                       Keystone_User[$admin_user]]
  }
  ...
  keystone_user { $monitord_user :
    ...
    domain   => 'services_user_domain',
    require  => Keystone_Domain['services_user_domain'],
  }

  keystone_user_role { "${monitord_user}@services":
    ensure         => present,
    roles          => ['monitoring'],
    user_domain    => 'services_user_domain',
    project_domain => 'services_project_domain',
    require        => [Keystone_Domain[['services_user_domain', 'services_project_domain']],
                       Keystone_User[$monitord_user]]
  }
