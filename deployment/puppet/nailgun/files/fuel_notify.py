...
from fuelclient.notifications import Notifications
...
Notifications.connection.user = ASTUTE_CONFIG['monitord']['user']
Notifications.connection.password = ASTUTE_CONFIG['monitord']['password']
...
def notify(message, topic=None):
    ...
    try:
        Notifications.send(message, topic=topic)
