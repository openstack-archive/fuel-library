...
class nailgun::cobbler(
  ...
  $bootstrap_profile = $bootstrap_flavor ? {
    /(?i)centos/                 => 'bootstrap_fuel',
    /(?i)ubuntu/                 => 'ubuntu_bootstrap_fuel',
    default                      => 'bootstrap_fuel',
  }
  ...
  case $production {
    'prod', 'docker': {
      ...
      cobbler_profile { 'centos-x86_64_DO_NOT_USE':
      ...
      cobbler_profile { 'ubuntu_1404_x86_64_DO_NOT_USE':
      ...
      cobbler_profile { 'bootstrap_fuel':
        distro    => 'bootstrap',
        menu      => true,
        kickstart => '',
      ...
      cobbler_profile { 'ubuntu_bootstrap_fuel':
