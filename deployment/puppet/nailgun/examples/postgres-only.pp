...
$keystone_dbuser   = $::fuel_settings['postgres']['keystone_dbname']
$keystone_dbpass   = $::fuel_settings['postgres']['keystone_user']
$keystone_dbname   = $::fuel_settings['postgres']['keystone_password']
...
# ostf db and grants
$ostf_dbuser   = $::fuel_settings['postgres']['ostf_dbname']
$ostf_dbpass   = $::fuel_settings['postgres']['ostf_user']
$ostf_dbname   = $::fuel_settings['postgres']['ostf_password']
