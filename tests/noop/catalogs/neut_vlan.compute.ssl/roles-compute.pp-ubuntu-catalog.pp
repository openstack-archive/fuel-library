...
augeas { 'libvirt-conf-uuid':
  changes => 'set host_uuid 8e8ec3ee-92b7-4469-83e7-7e0726acc607
',
...
class { 'Openstack::Compute':
  ...
  nova_hash                      => {'db_password' => 'of31Rxsy', 'state_path' => '/var/lib/nova', 'user_password' => 'n0KfayKg', 'vncproxy_protocol' => 'https'},
