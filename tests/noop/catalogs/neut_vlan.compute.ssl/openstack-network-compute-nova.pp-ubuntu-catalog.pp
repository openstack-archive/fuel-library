...
class { 'Nova::Network::Neutron':
  ...
  neutron_admin_auth_url          => 'http://10.122.7.7:35357/v2.0',
  neutron_admin_password          => 'glXcjTAY',
  ...
  neutron_url                     => 'http://10.122.7.7:9696',
...
nova_config { 'neutron/admin_auth_url':
  ...
  notify => 'Service[nova-compute]',
  value  => 'http://10.122.7.7:35357/v2.0',
}
