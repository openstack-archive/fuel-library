...
exec { 'waiting-for-neutron-api':
  ...
  environment => ['OS_TENANT_NAME=services', 'OS_USERNAME=neutron', 'OS_PASSWORD=XgdPodA7', 'OS_AUTH_URL=http://192.168.0.7:5000/v2.0', 'OS_REGION_NAME=RegionOne', 'OS_ENDPOINT_TYPE=internalURL'],
