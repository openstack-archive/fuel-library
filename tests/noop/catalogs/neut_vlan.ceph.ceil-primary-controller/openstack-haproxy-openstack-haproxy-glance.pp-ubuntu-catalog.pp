...
concat::fragment { 'glance-api_balancermember_glance-api':
  ...
  content => '  server node-125 192.168.0.3:9292  check inter 10s fastinter 2s downinter 3s rise 3 fall 3
',
...
concat::fragment { 'glance-registry_balancermember_glance-registry':
  ...
  content => '  server node-125 192.168.0.3:9191  check
',
...
haproxy::listen { 'glance-api':
  bind             => {'172.16.0.3:9292' => ['ssl', 'crt', '/var/lib/astute/haproxy/public_haproxy.pem'], '192.168.0.7:9292' => ''},
  bind_options     => '',
