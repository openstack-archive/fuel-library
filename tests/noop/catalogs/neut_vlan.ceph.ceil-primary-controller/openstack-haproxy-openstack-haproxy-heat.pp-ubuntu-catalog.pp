...
concat::fragment { 'heat-api-cfn_balancermember_heat-api-cfn':
  ...
  content => '  server node-125 192.168.0.3:8000  check inter 10s fastinter 2s downinter 3s rise 3 fall 3
',
...
concat::fragment { 'heat-api-cloudwatch_balancermember_heat-api-cloudwatch':
  ...
  content => '  server node-125 192.168.0.3:8003  check inter 10s fastinter 2s downinter 3s rise 3 fall 3
',
...
concat::fragment { 'heat-api_balancermember_heat-api':
  ...
  content => '  server node-125 192.168.0.3:8004  check inter 10s fastinter 2s downinter 3s rise 3 fall 3
',
...
haproxy::listen { 'heat-api-cfn':
  bind             => {'172.16.0.3:8000' => ['ssl', 'crt', '/var/lib/astute/haproxy/public_haproxy.pem'], '192.168.0.7:8000' => ''},
  bind_options     => '',
...
haproxy::listen { 'heat-api-cloudwatch':
  bind             => {'172.16.0.3:8003' => ['ssl', 'crt', '/var/lib/astute/haproxy/public_haproxy.pem'], '192.168.0.7:8003' => ''},
  bind_options     => '',
  collect_exported => 'true',
  name             => 'heat-api-cloudwatch',
  notify           => 'Exec[haproxy-restart]',
...
haproxy::listen { 'heat-api':
  bind             => {'172.16.0.3:8004' => ['ssl', 'crt', '/var/lib/astute/haproxy/public_haproxy.pem'], '192.168.0.7:8004' => ''},
  bind_options     => '',
  collect_exported => 'true',
  name             => 'heat-api',
  notify           => 'Exec[haproxy-restart]',
