...
class { 'Nova::Api':
  ...
  identity_uri                         => 'false',
  keystone_ec2_url                     => 'http://192.168.0.7:5000/v2.0/ec2tokens',
  manage_service                       => 'true',
  metadata_listen                      => '0.0.0.0',
  metadata_workers                     => '4',
  name                                 => 'Nova::Api',
  neutron_metadata_proxy_shared_secret => 'QU11ydS2',
...
class { 'Nova':
  ...
  ca_file                            => 'false',
  cert_file                          => 'false',
  database_connection                => 'mysql://nova:VXcP6cIR@192.168.0.7/nova?read_timeout=60',
...
class { 'Openstack::Controller':
  admin_address                  => '192.168.0.7',
  allowed_hosts                  => ['%', 'node-125'],
  ...
  nova_db_user                   => 'nova',
  nova_hash                      => {'db_password' => 'VXcP6cIR', 'state_path' => '/var/lib/nova', 'user_password' => 'fuhtZH6v'},
  ...
  nova_user                      => 'nova',
  nova_user_password             => 'fuhtZH6v',
  nova_user_tenant               => 'services',
  novnc_address                  => '192.168.0.3',
  num_networks                   => '',
...
exec { 'create-m1.micro-flavor':
  ...
  environment => ['OS_TENANT_NAME=services', 'OS_USERNAME=nova', 'OS_PASSWORD=fuhtZH6v', 'OS_AUTH_URL=http://192.168.0.7:5000/v2.0/', 'OS_ENDPOINT_TYPE=internalURL', 'OS_REGION_NAME=RegionOne', 'NOVA_ENDPOINT_TYPE=internalURL'],
...
nova_config { 'DEFAULT/keystone_ec2_url':
  ...
  notify => 'Exec[post-nova_config]',
  value  => 'http://192.168.0.7:5000/v2.0/ec2tokens',
}
...
nova_config { 'DEFAULT/novncproxy_base_url':
  ...
  notify => 'Exec[post-nova_config]',
  value  => 'http://192.168.0.3:6080/vnc_auto.html',
}
...
nova_config { 'database/connection':
  ...
  secret => 'true',
  value  => 'mysql://nova:VXcP6cIR@192.168.0.7/nova?read_timeout=60',
}
