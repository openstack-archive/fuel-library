...
class { 'Keystone::Endpoint':
  admin_url    => 'http://192.168.0.7:35357',
  internal_url => 'http://192.168.0.7:5000',
...
class { 'Keystone':
  ...
  database_connection                => 'mysql://keystone:e4Op1FQB@192.168.0.7/keystone?read_timeout=60',
...
keystone::resource::service_identity { 'keystone':
  admin_url             => 'http://192.168.0.7:35357/v2.0',
  auth_name             => 'keystone',
  ...
  ignore_default_tenant => 'false',
  internal_url          => 'http://192.168.0.7:5000/v2.0',
  name                  => 'keystone',
  password              => 'false',
...
keystone_config { 'database/connection':
  ...
  notify => ['Service[keystone]', 'Exec[keystone-manage db_sync]', 'Exec[keystone-manage pki_setup]', 'Service[httpd]'],
  secret => 'true',
  value  => 'mysql://keystone:e4Op1FQB@192.168.0.7/keystone?read_timeout=60',
}
