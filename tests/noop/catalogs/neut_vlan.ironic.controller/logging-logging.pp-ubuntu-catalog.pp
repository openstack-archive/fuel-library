class { 'Openstack::Logging':
  ...
  role             => 'client',
  rotation         => 'weekly',
  rservers         => {'port' => '514', 'remote_type' => 'tcp', 'server' => '10.109.37.2'},
  show_timezone    => 'true',
  virtual          => 'false',
}
...
$InputFileName /var/log/rabbitmq/rabbit@node-1-sasl.log
...
$InputFileName /var/log/rabbitmq/rabbit@node-1.log
...
rsyslog::imfile { '04-rabbitmq-sasl':
  ...
  file_name        => '/var/log/rabbitmq/rabbit@node-1-sasl.log',
...
rsyslog::imfile { '04-rabbitmq':
  file_facility    => 'syslog',
  file_name        => '/var/log/rabbitmq/rabbit@node-1.log',
  file_severity    => 'NOTICE',
  file_tag         => 'rabbitmq',
  name             => '04-rabbitmq',
  polling_interval => '10',
