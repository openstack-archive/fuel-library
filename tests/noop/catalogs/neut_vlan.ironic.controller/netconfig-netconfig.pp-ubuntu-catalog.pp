...
k_mod { '8021q':
  ...
  before => ['L2_bridge[br-baremetal]', 'L2_bridge[br-fw-admin]', 'L2_bridge[br-mgmt]', 'L2_bridge[br-storage]', 'L2_bridge[br-ex]', 'L2_bridge[br-floating]', 'L2_bridge[br-prv]', 'L2_bridge[br-ironic]', 'L2_bridge[br-baremetal]', 'L2_bridge[br-fw-admin]', 'L2_bridge[br-mgmt]', 'L2_bridge[br-storage]', 'L2_bridge[br-ex]', 'L2_bridge[br-floating]', 'L2_bridge[br-prv]', 'L2_bridge[br-ironic]', 'L2_bridge[br-baremetal]', 'L2_bridge[br-fw-admin]', 'L2_bridge[br-mgmt]', 'L2_bridge[br-storage]', 'L2_bridge[br-ex]', 'L2_bridge[br-floating]', 'L2_bridge[br-prv]', 'L2_bridge[br-ironic]', 'L2_bridge[br-baremetal]', 'L2_bridge[br-fw-admin]', 'L2_bridge[br-mgmt]', 'L2_bridge[br-storage]', 'L2_bridge[br-ex]', 'L2_bridge[br-floating]', 'L2_bridge[br-prv]', 'L2_bridge[br-ironic]', 'L2_bridge[br-baremetal]', 'L2_bridge[br-fw-admin]', 'L2_bridge[br-mgmt]', 'L2_bridge[br-storage]', 'L2_bridge[br-ex]', 'L2_bridge[br-floating]', 'L2_bridge[br-prv]', 'L2_bridge[br-ironic]', 'L2_bridge[br-baremetal]', 'L2_bridge[br-fw-admin]', 'L2_bridge[br-mgmt]', 'L2_bridge[br-storage]', 'L2_bridge[br-ex]', 'L2_bridge[br-floating]', 'L2_bridge[br-prv]', 'L2_bridge[br-ironic]', 'L2_patch[patch__br-ex--br-floating]', 'L2_patch[patch__br-fw-admin--br-prv]', 'L2_patch[patch__br-baremetal--br-ironic]', 'L2_bridge[br-baremetal]', 'L2_bridge[br-fw-admin]', 'L2_bridge[br-mgmt]', 'L2_bridge[br-storage]', 'L2_bridge[br-ex]', 'L2_bridge[br-floating]', 'L2_bridge[br-prv]', 'L2_bridge[br-ironic]', 'L2_patch[patch__br-ex--br-floating]', 'L2_patch[patch__br-fw-admin--br-prv]', 'L2_patch[patch__br-baremetal--br-ironic]', 'L2_port[eth0]', 'L2_port[eth0.101]', 'L2_port[eth0.102]', 'L2_port[eth1]', 'L2_port[eth5]', 'L2_port[eth0]', 'L2_port[eth0.101]', 'L2_port[eth0.102]', 'L2_port[eth1]', 'L2_port[eth5]', 'L2_port[eth0]', 'L2_port[eth0.101]', 'L2_port[eth0.102]', 'L2_port[eth1]', 'L2_port[eth5]', 'L2_port[eth0]', 'L2_port[eth0.101]', 'L2_port[eth0.102]', 'L2_port[eth1]', 'L2_port[eth5]', 'L2_port[eth0]', 'L2_port[eth0.101]', 'L2_port[eth0.102]', 'L2_port[eth1]', 'L2_port[eth5]', 'L2_bridge[br-baremetal]', 'L2_bridge[br-fw-admin]', 'L2_bridge[br-mgmt]', 'L2_bridge[br-storage]', 'L2_bridge[br-ex]', 'L2_bridge[br-floating]', 'L2_bridge[br-prv]', 'L2_bridge[br-ironic]', 'L2_patch[patch__br-ex--br-floating]', 'L2_patch[patch__br-fw-admin--br-prv]', 'L2_patch[patch__br-baremetal--br-ironic]'],
  module => '8021q',
}
...
l23_stored_config { 'br-baremetal':
  ensure       => 'present',
  before       => ['Enable_hotplug[global]', 'L2_bridge[br-baremetal]', 'L3_ifconfig[br-baremetal]'],
  bridge_ports => 'none',
  if_type      => 'bridge',
  ipaddr       => '192.168.3.3/24',
  method       => 'static',
  name         => 'br-baremetal',
  provider     => 'lnx_ubuntu',
}
...
l23_stored_config { 'br-floating':
  ...
  before       => ['Enable_hotplug[global]', 'L2_bridge[br-floating]', 'L3_ifconfig[br-floating]'],
  bridge_ports => 'none',
  if_type      => 'bridge',
  ipaddr       => 'none',
  method       => 'manual',
...
l23_stored_config { 'br-fw-admin':
  ...
  bridge_ports => 'none',
  if_type      => 'bridge',
  ipaddr       => '10.109.37.4/24',
  method       => 'static',
  name         => 'br-fw-admin',
  provider     => 'lnx_ubuntu',
}

l23_stored_config { 'br-ironic':
  ensure       => 'present',
  before       => ['Enable_hotplug[global]', 'L2_bridge[br-ironic]'],
  bridge_ports => 'none',
  if_type      => 'bridge',
  name         => 'br-ironic',
  provider     => 'ovs_ubuntu',
...
l23_stored_config { 'eth5':
  ensure          => 'present',
  before          => ['Enable_hotplug[global]', 'L2_port[eth5]'],
  bridge          => 'br-baremetal',
  name            => 'eth5',
  provider        => 'lnx_ubuntu',
  vendor_specific => {'bus_info' => '0000:00:08.0', 'driver' => 'e1000'},
}

l23_stored_config { 'p_625d4df9-0':
  ensure   => 'present',
  before   => ['Enable_hotplug[global]', 'L2_patch[patch__br-baremetal--br-ironic]'],
  bridge   => ['br-ironic', 'br-baremetal'],
  if_type  => 'ethernet',
  jacks    => ['p_625d4df9-0', 'p_625d4df9-1'],
  mtu      => '65000',
  name     => 'p_625d4df9-0',
  onboot   => 'true',
  provider => 'ovs_ubuntu',
...
l23_stored_config { 'p_ff798dba-0':
  ...
  before   => ['Enable_hotplug[global]', 'L2_patch[patch__br-ex--br-floating]'],
  bridge   => ['br-floating', 'br-ex'],
  if_type  => 'ethernet',
  jacks    => ['p_ff798dba-0', 'p_ff798dba-1'],
  mtu      => '65000',
  name     => 'p_ff798dba-0',
  onboot   => 'true',
  provider => 'ovs_ubuntu',
...
l23network::l2::bridge { 'br-baremetal':
  ensure       => 'present',
  before       => 'L3_ifconfig[br-baremetal]',
  bpdu_forward => 'true',
  external_ids => {'bridge-id' => 'br-baremetal'},
  name         => 'br-baremetal',
  provider     => 'lnx',
  use_ovs      => 'true',
}
...
l23network::l2::bridge { 'br-floating':
  ensure       => 'present',
  before       => 'L3_ifconfig[br-floating]',
  bpdu_forward => 'true',
...
l23network::l2::bridge { 'br-fw-admin':
  ...
  name         => 'br-fw-admin',
  provider     => 'lnx',
  require      => 'L23network::L3::Ifconfig[br-baremetal]',
  use_ovs      => 'true',
}
...
l23network::l2::bridge { 'br-ironic':
  ...
  bpdu_forward => 'true',
  external_ids => {'bridge-id' => 'br-ironic'},
  name         => 'br-ironic',
  provider     => 'ovs',
  require      => 'L23network::L2::Port[eth5]',
  use_ovs      => 'true',
}
...
l23network::l2::bridge { 'br-prv':
  ...
  name         => 'br-prv',
  provider     => 'ovs',
  require      => 'L23network::L2::Patch[patch__br-ex--br-floating]',
  use_ovs      => 'true',
}
...
l23network::l2::patch { 'patch__br-baremetal--br-ironic':
  ensure   => 'present',
  bridges  => ['br-ironic', 'br-baremetal'],
  mtu      => '65000',
  name     => 'patch__br-baremetal--br-ironic',
  provider => 'ovs',
  require  => 'L23network::L2::Bridge[br-ironic]',
  use_ovs  => 'true',
  vlan_ids => ['0', '0'],
}

l23network::l2::patch { 'patch__br-ex--br-floating':
  ensure   => 'present',
  bridges  => ['br-floating', 'br-ex'],
  mtu      => '65000',
  name     => 'patch__br-ex--br-floating',
  provider => 'ovs',
  require  => 'L23network::L3::Ifconfig[br-floating]',
  use_ovs  => 'true',
  vlan_ids => ['0', '0'],
}
...
l23network::l3::ifconfig { 'br-baremetal':
  ensure                => 'present',
  ...
  ipaddr                => '192.168.3.3/24',
  name                  => 'br-baremetal',
  require               => 'L23network::L2::Bridge[br-baremetal]',
}
...
l23network::l3::ifconfig { 'br-floating':
  ensure                => 'present',
  check_by_ping         => 'gateway',
  check_by_ping_timeout => '30',
  ...
  ipaddr                => 'none',
  name                  => 'br-floating',
  require               => 'L23network::L2::Bridge[br-floating]',
}
...
l2_patch { 'patch__br-baremetal--br-ironic':
  ensure   => 'present',
  bridges  => ['br-ironic', 'br-baremetal'],
  jacks    => ['p_625d4df9-0', 'p_625d4df9-1'],
  mtu      => '65000',
...
l2_port { 'eth0.101':
  ...
  before    => ['Enable_hotplug[global]', 'Sysfs_config_value[rps_cpus]', 'Sysfs_config_value[xps_cpus]', 'Ping_host[172.16.51.113]'],
  bridge    => 'br-mgmt',
  interface => 'eth0.101',
  provider  => 'lnx',
  use_ovs   => 'true',
