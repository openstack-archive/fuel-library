...
class { 'Neutron::Server::Notifications':
  ...
  nova_admin_auth_url                => 'http://192.168.0.2:35357/v2.0/',
  nova_admin_password                => 'jxcyBid9g7iEWreQdmQzsJ8I',
  nova_admin_tenant_name             => 'services',
  nova_admin_username                => 'nova',
  nova_region_name                   => 'RegionOne',
  nova_url                           => 'http://192.168.0.2:8774/v2',
...
class { 'Neutron::Server':
  ...
  auth_host                        => 'localhost',
  auth_password                    => 'XzCvbGgI0KfqgoHYGXPTkTgY',
  auth_port                        => '35357',
  auth_protocol                    => 'http',
  ...
  auth_user                        => 'neutron',
  database_connection              => 'mysql://neutron:R7CwXDC1rgSbz6z0oL38xb4S@192.168.0.2/neutron?&read_timeout=60',
...
neutron_config { 'DEFAULT/nova_url':
  ...
  notify => 'Service[neutron-server]',
  value  => 'http://192.168.0.2:8774/v2',
}
...
neutron_config { 'database/connection':
  ...
  notify => 'Service[neutron-server]',
  secret => 'true',
  value  => 'mysql://neutron:R7CwXDC1rgSbz6z0oL38xb4S@192.168.0.2/neutron?&read_timeout=60',
}
...
nova_admin_tenant_id_setter { 'nova_admin_tenant_id':
  ...
  auth_password    => 'jxcyBid9g7iEWreQdmQzsJ8I',
