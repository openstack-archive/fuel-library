...
concat::fragment { 'neutron_balancermember_neutron':
  ...
  content => '  server node-1 192.168.0.3:9696  check inter 10s fastinter 2s downinter 3s rise 3 fall 3
',
...
concat::fragment { 'neutron_listen_block':
  content => '
listen neutron
  bind 172.16.51.116:9696 ssl crt /var/lib/astute/haproxy/public_haproxy.pem
...
haproxy::listen { 'neutron':
  bind             => {'172.16.51.116:9696' => ['ssl', 'crt', '/var/lib/astute/haproxy/public_haproxy.pem'], '192.168.0.2:9696' => ''},
  bind_options     => '',
