class { 'Glance::Api':
  ...
  ca_file                  => 'false',
  cert_file                => 'false',
  database_connection      => 'mysql://glance:nNVZnNgNLYYIolcKRcWb2c3J@192.168.0.2/glance?read_timeout=60',
  ...
  key_file                 => 'false',
  keystone_password        => 'lDOkW0TlkoMY4CmPy8PiW80E',
...
class { 'Glance::Backend::Swift':
  ...
  swift_store_key                     => 'lDOkW0TlkoMY4CmPy8PiW80E',
...
class { 'Openstack::Glance':
  ...
  glance_db_password             => 'nNVZnNgNLYYIolcKRcWb2c3J',
  glance_db_user                 => 'glance',
  glance_image_cache_max_size    => '10714349568',
  glance_tenant                  => 'services',
  glance_user                    => 'glance',
  glance_user_password           => 'lDOkW0TlkoMY4CmPy8PiW80E',
...
glance_api_config { 'database/connection':
  ...
  notify => ['Service[glance-api]', 'Exec[glance-manage db_sync]'],
  secret => 'true',
  value  => 'mysql://glance:nNVZnNgNLYYIolcKRcWb2c3J@192.168.0.2/glance?read_timeout=60',
}
...
glance_api_config { 'glance_store/swift_store_key':
  ...
  notify => ['Service[glance-api]', 'Exec[glance-manage db_sync]'],
  value  => 'lDOkW0TlkoMY4CmPy8PiW80E',
}
