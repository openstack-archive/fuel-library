...
cs_resource { 'sysinfo_node-1.test.domain.local':
  ensure          => 'present',
  name            => 'sysinfo_node-1.test.domain.local',
...
cs_rsc_location { 'sysinfo-on-node-1.test.domain.local':
  cib        => 'sysinfo_node-1.test.domain.local',
  name       => 'sysinfo-on-node-1.test.domain.local',
  node_name  => 'node-1.test.domain.local',
  node_score => 'INFINITY',
  primitive  => 'sysinfo_node-1.test.domain.local',
}
