...
class { 'Pacemaker_wrappers::Rabbitmq':
  admin_pass      => 'OLCrvt99FgutnBs63PeFJchF',
  admin_user      => 'nova',
...
class { 'Rabbitmq':
  ...
  default_pass               => 'OLCrvt99FgutnBs63PeFJchF',
  default_user               => 'nova',
...
cs_resource { 'p_rabbitmq-server':
  ...
  parameters      => {'admin_password' => 'OLCrvt99FgutnBs63PeFJchF', 'admin_user' => 'nova', 'command_timeout' => ''--signal=KILL'', 'debug' => 'false', 'erlang_cookie' => 'EOKOWXQREETZSHFNTPEY', 'node_port' => '5673'},
  primitive_class => 'ocf',
  primitive_type  => 'rabbitmq-server',
  provided_by     => 'fuel',
}
...
exec { '/var/lib/rabbitmq/rabbitmqadmin':
  command   => 'curl -k --noproxy localhost --retry 30 --retry-delay 6 -f -L -o /var/lib/rabbitmq/rabbitmqadmin http://nova:OLCrvt99FgutnBs63PeFJchF@localhost:15672/cli/rabbitmqadmin',
...
# OCF Parameters
                                    ...
                                    export OCF_RESKEY_admin_password='OLCrvt99FgutnBs63PeFJchF'
...
staging::file { 'rabbitmqadmin':
  ...
  source      => 'http://nova:OLCrvt99FgutnBs63PeFJchF@localhost:15672/cli/rabbitmqadmin',
  subdir      => 'rabbitmq',
