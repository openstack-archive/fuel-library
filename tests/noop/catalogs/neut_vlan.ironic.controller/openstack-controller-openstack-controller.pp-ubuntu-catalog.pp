...
class { 'Nova::Api':
  admin_password                       => 'jxcyBid9g7iEWreQdmQzsJ8I',
  ...
  metadata_workers                     => '4',
  name                                 => 'Nova::Api',
  neutron_metadata_proxy_shared_secret => 'IFcIv8CuNbllNccJs2bvcrkH',
...
class { 'Openstack::Controller':
  ...
  nova_db_user                   => 'nova',
  nova_hash                      => {'db_password' => 'HyPHllrMCyYPLDhhT93Cs7TJ', 'state_path' => '/var/lib/nova', 'user_password' => 'jxcyBid9g7iEWreQdmQzsJ8I'},
...
exec { 'create-m1.micro-flavor':
  ...
  environment => ['OS_TENANT_NAME=services', 'OS_USERNAME=nova', 'OS_PASSWORD=jxcyBid9g7iEWreQdmQzsJ8I', 'OS_AUTH_URL=http://192.168.0.2:5000/v2.0/', 'OS_ENDPOINT_TYPE=internalURL', 'OS_REGION_NAME=RegionOne', 'NOVA_ENDPOINT_TYPE=internalURL'],
...
nova_config { 'DEFAULT/keystone_ec2_url':
  ...
  notify => 'Exec[post-nova_config]',
  value  => 'http://192.168.0.2:5000/v2.0/ec2tokens',
}
...
nova_config { 'keystone_authtoken/admin_password':
  ...
  notify => 'Exec[post-nova_config]',
  secret => 'true',
  value  => 'jxcyBid9g7iEWreQdmQzsJ8I',
}
...
nova_config { 'neutron/metadata_proxy_shared_secret':
  ...
  notify => 'Exec[post-nova_config]',
  value  => 'IFcIv8CuNbllNccJs2bvcrkH',
}
