...
class { 'Keystone':
  ...
  database_connection                => 'mysql://keystone:xl0tg0dvg80jNMGvBfb83YSn@192.168.0.2/keystone?read_timeout=60',
...
keystone_config { 'DEFAULT/admin_token':
  ...
  notify => ['Service[keystone]', 'Exec[keystone-manage db_sync]', 'Exec[keystone-manage pki_setup]', 'Service[httpd]'],
  secret => 'true',
  value  => 'fEba1VO69rCHVWjM61sZ4Q5x',
}
...
keystone_config { 'database/connection':
  ...
  notify => ['Service[keystone]', 'Exec[keystone-manage db_sync]', 'Exec[keystone-manage pki_setup]', 'Service[httpd]'],
  secret => 'true',
  value  => 'mysql://keystone:xl0tg0dvg80jNMGvBfb83YSn@192.168.0.2/keystone?read_timeout=60',
}
