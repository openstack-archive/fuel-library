...
k_mod { '8021q':
  ...
  before => ['L2_bridge[br-fw-admin]', 'L2_bridge[br-mgmt]', 'L2_bridge[br-storage]', 'L2_bridge[br-fw-admin]', 'L2_bridge[br-mgmt]', 'L2_bridge[br-storage]', 'L2_bridge[br-fw-admin]', 'L2_bridge[br-mgmt]', 'L2_bridge[br-storage]', 'L2_port[eth0]', 'L2_port[eth0.102]', 'L2_port[eth0.101]', 'L2_port[eth0]', 'L2_port[eth0.102]', 'L2_port[eth0.101]', 'L2_port[eth0]', 'L2_port[eth0.102]', 'L2_port[eth0.101]'],
  module => '8021q',
}
...
notify { 'SDN':
  message => 'add-br(br-fw-admin) -> endpoint(br-fw-admin) -> add-br(br-mgmt) -> endpoint(br-mgmt) -> add-br(br-storage) -> endpoint(br-storage) -> add-port(eth0) -> add-port(eth0.102) -> add-port(eth0.101)',
  name    => 'SDN',
}
