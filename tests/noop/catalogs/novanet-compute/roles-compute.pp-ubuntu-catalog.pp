...
augeas { 'libvirt-conf-uuid':
  changes => 'set host_uuid c946ed98-54c4-47af-8697-429cc6ba2903
',
...
class { 'Openstack::Compute':
  ...
  nova_hash                      => {'db_password' => 'aAU4jYDt', 'state_path' => '/var/lib/nova', 'user_password' => 'UyrT2Ama', 'vncproxy_protocol' => 'https'},
