...
ceilometer_config { 'database/connection':
  ...
  secret => 'true',
  value  => 'mongodb://ceilometer:ceilometer@/ceilometer',
}
...
class { 'Ceilometer::Db':
  database_connection => 'mongodb://ceilometer:ceilometer@/ceilometer',
  name                => 'Ceilometer::Db',
  sync_db             => 'true',
}
