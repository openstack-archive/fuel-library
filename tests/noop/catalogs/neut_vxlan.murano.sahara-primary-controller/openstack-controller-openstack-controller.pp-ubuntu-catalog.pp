...
class { 'Nova::Api':
  admin_password                       => 'fj4wVCEs',
  admin_tenant_name                    => 'services',
  admin_user                           => 'nova',
  api_bind_address                     => '192.168.0.2',
  ...
  metadata_workers                     => '4',
  name                                 => 'Nova::Api',
  neutron_metadata_proxy_shared_secret => 'fp618p5V',
...
class { 'Nova':
  ...
  ca_file                            => 'false',
  cert_file                          => 'false',
  database_connection                => 'mysql://nova:mqnsUMgC@192.168.0.2/nova?read_timeout=60',
...
class { 'Openstack::Controller':
  ...
  nova_db_user                   => 'nova',
  nova_hash                      => {'db_password' => 'mqnsUMgC', 'state_path' => '/var/lib/nova', 'user_password' => 'fj4wVCEs'},
  ...
  novnc_address                  => '192.168.0.2',
  num_networks                   => '',
  primary_controller             => 'true',
  private_interface              => 'false',
  public_address                 => '10.109.1.2',
  public_interface               => '',
...
exec { 'create-m1.micro-flavor':
  ...
  environment => ['OS_TENANT_NAME=services', 'OS_USERNAME=nova', 'OS_PASSWORD=fj4wVCEs', 'OS_AUTH_URL=http://192.168.0.2:5000/v2.0/', 'OS_ENDPOINT_TYPE=internalURL', 'OS_REGION_NAME=RegionOne', 'NOVA_ENDPOINT_TYPE=internalURL'],
...
nova_config { 'DEFAULT/novncproxy_base_url':
  ...
  notify => 'Exec[post-nova_config]',
  value  => 'http://192.168.0.2:6080/vnc_auto.html',
}
...
nova_config { 'database/connection':
  ...
  secret => 'true',
  value  => 'mysql://nova:mqnsUMgC@192.168.0.2/nova?read_timeout=60',
}
