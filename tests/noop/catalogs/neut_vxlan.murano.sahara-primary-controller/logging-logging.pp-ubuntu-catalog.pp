...
$InputFileName /var/log/rabbitmq/rabbit@node-128-sasl.log
...
$InputFileName /var/log/rabbitmq/rabbit@node-128.log
...
rsyslog::imfile { '04-rabbitmq-sasl':
  ...
  file_name        => '/var/log/rabbitmq/rabbit@node-128-sasl.log',
...
rsyslog::imfile { '04-rabbitmq':
  file_facility    => 'syslog',
  file_name        => '/var/log/rabbitmq/rabbit@node-128.log',
  file_severity    => 'NOTICE',
  file_tag         => 'rabbitmq',
  name             => '04-rabbitmq',
  polling_interval => '10',
