...
concat::fragment { 'neutron_balancermember_neutron':
  ...
  content => '  server node-128 192.168.0.2:9696  check inter 10s fastinter 2s downinter 3s rise 3 fall 3
  server node-129 192.168.0.3:9696  check inter 10s fastinter 2s downinter 3s rise 3 fall 3
  server node-131 192.168.0.4:9696  check inter 10s fastinter 2s downinter 3s rise 3 fall 3
',
...
concat::fragment { 'neutron_listen_block':
  content => '
listen neutron
  bind 10.109.1.2:9696 ssl crt /var/lib/astute/haproxy/public_haproxy.pem
...
haproxy::listen { 'neutron':
  bind             => {'10.109.1.2:9696' => ['ssl', 'crt', '/var/lib/astute/haproxy/public_haproxy.pem'], '192.168.0.2:9696' => ''},
  bind_options     => '',
