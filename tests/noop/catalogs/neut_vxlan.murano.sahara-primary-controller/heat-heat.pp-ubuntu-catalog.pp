...
class { 'Heat::Keystone::Domain':
  ...
  domain_name        => 'heat',
  domain_password    => 'EWJfBLJ9',
  keystone_admin     => 'heat',
  keystone_password  => 'EWJfBLJ9',
...
class { 'Heat':
  ...
  sql_connection                     => 'mysql://heat:AuaPc3Yq@192.168.0.2/heat?read_timeout=60',
  sync_db                            => 'true',
  use_stderr                         => 'false',
  use_syslog                         => 'true',
  verbose                            => 'true',
...
class { 'Openstack::Heat':
  ...
  amqp_user                     => 'nova',
  api_bind_host                 => '192.168.0.2',
  api_bind_port                 => '8004',
  api_cfn_bind_host             => '192.168.0.2',
  api_cfn_bind_port             => '8000',
  api_cloudwatch_bind_host      => '192.168.0.2',
...
heat_config { 'DEFAULT/auth_encryption_key':
  ...
  notify => ['Service[heat-engine]', 'Service[heat-api]', 'Service[heat-api-cfn]', 'Service[heat-api-cloudwatch]'],
  value  => '8edb899a7e81e56abe51639880aa32dd',
}
...
heat_config { 'database/connection':
  ...
  secret => 'true',
  value  => 'mysql://heat:AuaPc3Yq@192.168.0.2/heat?read_timeout=60',
}
