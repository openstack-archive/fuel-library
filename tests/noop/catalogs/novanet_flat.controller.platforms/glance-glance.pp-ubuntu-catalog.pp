class { 'Glance::Api':
  ...
  auth_type                => 'keystone',
  auth_uri                 => 'false',
  auth_url                 => 'http://10.108.2.2:5000/',
  backlog                  => '4096',
  before                   => 'Class[Glance::Cache::Pruner]',
  bind_host                => '10.108.2.4',
  bind_port                => '9292',
  ca_file                  => 'false',
  cert_file                => 'false',
  database_connection      => 'mysql://glance:n1x6qtJg@10.108.2.2/glance?read_timeout=60',
...
class { 'Glance::Backend::Swift':
  ...
  swift_store_auth_address            => 'http://10.108.2.2:5000/v2.0/',
  swift_store_auth_version            => '2',
  swift_store_container               => 'glance',
  swift_store_create_container_on_put => 'True',
  swift_store_endpoint_type           => 'internalURL',
  swift_store_key                     => 'HQQj24u9',
...
glance_api_config { 'database/connection':
  ...
  notify => ['Service[glance-api]', 'Exec[glance-manage db_sync]'],
  secret => 'true',
  value  => 'mysql://glance:n1x6qtJg@10.108.2.2/glance?read_timeout=60',
}
