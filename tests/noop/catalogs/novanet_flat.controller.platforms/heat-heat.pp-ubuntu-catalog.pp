...
class { 'Heat::Engine':
  ...
  heat_metadata_server_url            => 'http://10.108.2.2:8000',
  heat_stack_user_role                => 'heat_stack_user',
  heat_waitcondition_server_url       => 'http://10.108.2.2:8000/v1/waitcondition',
  heat_watch_server_url               => 'http://10.108.2.2:8003',
  manage_service                      => 'true',
  name                                => 'Heat::Engine',
  package_ensure                      => 'present',
...
class { 'Heat::Keystone::Domain':
  auth_url           => 'http://10.108.2.2:35357/v2.0',
  domain_admin       => 'heat_admin',
  domain_admin_email => 'heat_admin@localhost',
  domain_name        => 'heat',
  domain_password    => 'Z2rvUcbg',
  keystone_admin     => 'heat',
  keystone_password  => 'Z2rvUcbg',
...
class { 'Heat':
  ...
  debug                              => 'true',
  identity_uri                       => 'false',
  keystone_ec2_uri                   => 'http://10.108.2.2:5000/v2.0',
  ...
  sql_connection                     => 'mysql://heat:ey8Q2Tmb@10.108.2.2/heat?read_timeout=60',
  sync_db                            => 'true',
  use_stderr                         => 'false',
  use_syslog                         => 'true',
  verbose                            => 'true',
...
class { 'Openstack::Heat':
  ...
  amqp_user                     => 'nova',
  api_bind_host                 => '10.108.2.4',
  api_bind_port                 => '8004',
  api_cfn_bind_host             => '10.108.2.4',
  api_cfn_bind_port             => '8000',
  api_cloudwatch_bind_host      => '10.108.2.4',
...
heat_config { 'DEFAULT/auth_encryption_key':
  ...
  notify => ['Service[heat-engine]', 'Service[heat-api]', 'Service[heat-api-cfn]', 'Service[heat-api-cloudwatch]'],
  value  => 'd69db5365b0329c49d01155175f6a45f',
}
...
heat_config { 'DEFAULT/heat_waitcondition_server_url':
  ...
  notify => ['Service[heat-engine]', 'Service[heat-api]', 'Service[heat-api-cfn]', 'Service[heat-api-cloudwatch]'],
  value  => 'http://10.108.2.2:8000/v1/waitcondition',
}
...
heat_config { 'database/connection':
  ...
  secret => 'true',
  value  => 'mysql://heat:ey8Q2Tmb@10.108.2.2/heat?read_timeout=60',
}
