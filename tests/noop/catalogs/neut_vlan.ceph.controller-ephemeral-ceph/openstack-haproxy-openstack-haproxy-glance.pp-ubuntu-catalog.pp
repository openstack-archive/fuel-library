...
concat::fragment { 'glance-api_balancermember_glance-api':
  ...
  content => '  server node-1 10.122.12.3:9292  check inter 10s fastinter 2s downinter 3s rise 3 fall 3
',
...
concat::fragment { 'glance-api_listen_block':
  content => '
listen glance-api
  bind 10.122.11.3:9292 ssl crt /var/lib/astute/haproxy/public_haproxy.pem
  bind 10.122.12.2:9292 
...
concat::fragment { 'glance-registry_balancermember_glance-registry':
  ...
  content => '  server node-1 10.122.12.3:9191  check
',
...
haproxy::listen { 'glance-api':
  bind             => {'10.122.11.3:9292' => ['ssl', 'crt', '/var/lib/astute/haproxy/public_haproxy.pem'], '10.122.12.2:9292' => ''},
  bind_options     => '',
