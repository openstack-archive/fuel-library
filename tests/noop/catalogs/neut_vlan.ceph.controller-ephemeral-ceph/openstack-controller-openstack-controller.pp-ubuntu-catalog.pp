...
class { 'Nova::Api':
  admin_password                       => 'vhdwzqrw',
  admin_tenant_name                    => 'services',
  admin_user                           => 'nova',
  api_bind_address                     => '10.122.12.3',
  ...
  identity_uri                         => 'false',
  keystone_ec2_url                     => 'http://10.122.12.2:5000/v2.0/ec2tokens',
  manage_service                       => 'true',
  metadata_listen                      => '0.0.0.0',
  metadata_workers                     => '4',
  name                                 => 'Nova::Api',
  neutron_metadata_proxy_shared_secret => 'P3Hi55Hg',
...
class { 'Nova':
  ...
  ca_file                            => 'false',
  cert_file                          => 'false',
  database_connection                => 'mysql://nova:seh61drS@10.122.12.2/nova?read_timeout=60',
...
class { 'Openstack::Controller':
  ...
  nova_db_user                   => 'nova',
  nova_hash                      => {'db_password' => 'seh61drS', 'state_path' => '/var/lib/nova', 'user_password' => 'vhdwzqrw'},
  ...
  novnc_address                  => '10.122.12.3',
  num_networks                   => '',
  primary_controller             => 'true',
  private_interface              => 'false',
  public_address                 => '10.122.11.3',
  public_interface               => '',
...
exec { 'create-m1.micro-flavor':
  ...
  environment => ['OS_TENANT_NAME=services', 'OS_USERNAME=nova', 'OS_PASSWORD=vhdwzqrw', 'OS_AUTH_URL=http://10.122.12.2:5000/v2.0/', 'OS_ENDPOINT_TYPE=internalURL', 'OS_REGION_NAME=RegionOne', 'NOVA_ENDPOINT_TYPE=internalURL'],
...
haproxy_backend_status { 'nova-api':
  before => 'Exec[create-m1.micro-flavor]',
  name   => 'nova-api-2',
...
nova_config { 'DEFAULT/keystone_ec2_url':
  ...
  notify => 'Exec[post-nova_config]',
  value  => 'http://10.122.12.2:5000/v2.0/ec2tokens',
}
...
nova_config { 'DEFAULT/novncproxy_base_url':
  ...
  notify => 'Exec[post-nova_config]',
  value  => 'http://10.122.12.3:6080/vnc_auto.html',
}
...
nova_config { 'database/connection':
  ...
  secret => 'true',
  value  => 'mysql://nova:seh61drS@10.122.12.2/nova?read_timeout=60',
}
