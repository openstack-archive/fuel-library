...
concat::fragment { 'neutron_balancermember_neutron':
  ...
  content => '  server node-1 10.122.12.3:9696  check inter 10s fastinter 2s downinter 3s rise 3 fall 3
',
...
concat::fragment { 'neutron_listen_block':
  content => '
listen neutron
  bind 10.122.11.3:9696 ssl crt /var/lib/astute/haproxy/public_haproxy.pem
  bind 10.122.12.2:9696 
  option  httpchk
  option  httplog
  option  httpclose
',
...
haproxy::listen { 'neutron':
  bind             => {'10.122.11.3:9696' => ['ssl', 'crt', '/var/lib/astute/haproxy/public_haproxy.pem'], '10.122.12.2:9696' => ''},
  bind_options     => '',
