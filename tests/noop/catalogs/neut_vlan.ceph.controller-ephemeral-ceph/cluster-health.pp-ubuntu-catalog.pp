...
cs_resource { 'sysinfo_node-1.domain.local':
  ensure          => 'present',
  name            => 'sysinfo_node-1.domain.local',
...
cs_rsc_location { 'sysinfo-on-node-1.domain.local':
  cib        => 'sysinfo_node-1.domain.local',
  name       => 'sysinfo-on-node-1.domain.local',
  node_name  => 'node-1.domain.local',
  node_score => 'INFINITY',
  primitive  => 'sysinfo_node-1.domain.local',
}
