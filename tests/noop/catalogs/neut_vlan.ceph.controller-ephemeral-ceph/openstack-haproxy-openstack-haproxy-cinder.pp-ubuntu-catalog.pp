...
concat::fragment { 'cinder-api_balancermember_cinder-api':
  ...
  content => '  server node-1 10.122.12.3:8776  check inter 10s fastinter 2s downinter 3s rise 3 fall 3
',
...
concat::fragment { 'cinder-api_listen_block':
  content => '
listen cinder-api
  bind 10.122.11.3:8776 ssl crt /var/lib/astute/haproxy/public_haproxy.pem
  bind 10.122.12.2:8776 
  option  httpchk
  option  httplog
  option  httpclose
',
...
haproxy::listen { 'cinder-api':
  bind             => {'10.122.11.3:8776' => ['ssl', 'crt', '/var/lib/astute/haproxy/public_haproxy.pem'], '10.122.12.2:8776' => ''},
  bind_options     => '',
