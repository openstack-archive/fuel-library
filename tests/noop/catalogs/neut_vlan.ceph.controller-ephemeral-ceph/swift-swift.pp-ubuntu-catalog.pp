...
class { 'Openstack::Swift::Proxy':
  ...
  master_swift_proxy_ip            => '10.122.12.3',
  ...
  swift_proxies_cache              => '10.122.12.3',
  swift_proxy_local_ipaddr         => '10.122.12.3',
  swift_replication_local_ipaddr   => '10.122.14.1',
  swift_user_password              => 'BmPWa1XA',
  verbose                          => 'true',
}
...
class { 'Openstack::Swift::Status':
  ...
  con_timeout => '5',
  endpoint    => 'http://10.122.12.3:8080',
  name        => 'Openstack::Swift::Status',
  only_from   => '127.0.0.1 240.0.0.2 10.122.14.0/24 10.122.12.0/24',
  port        => '49001',
  vip         => '10.122.12.2',
}
...
class { 'Openstack::Swift::Storage_node':
  ...
  storage_weight              => '1',
  swift_hash_suffix           => 'swift_secret',
  swift_local_net_ip          => '10.122.14.1',
  swift_max_header_size       => '32768',
  swift_zone                  => '1',
  sync_rings                  => 'false',
...
class { 'Swift::Dispersion':
  ...
  auth_url      => 'http://10.122.12.2:5000/v2.0/',
  auth_user     => 'swift',
  auth_version  => '2.0',
  concurrency   => '25',
  coverage      => '1',
...
class { 'Swift::Proxy::Cache':
  memcache_servers => '10.122.12.3:11211',
...
class { 'Swift::Proxy':
  ...
  port                     => '8080',
  proxy_local_net_ip       => '10.122.12.3',
  workers                  => '4',
}
...
class { 'Swift::Storage::All':
  ...
  object_port          => '6000',
  outgoing_chmod       => '0644',
  storage_local_net_ip => '10.122.14.1',
}
...
exec { 'swift-dispersion-populate':
  ...
  onlyif    => 'swift -A http://10.122.12.2:5000/v2.0/ -U services:swift -K BmPWa1XA -V 2.0 stat | grep 'Account: '',
  path      => ['/bin', '/usr/bin'],
  require   => 'Package[swiftclient]',
  subscribe => 'File[/etc/swift/dispersion.conf]',
  timeout   => '0',
  unless    => 'swift -A http://10.122.12.2:5000/v2.0/ -U services:swift -K BmPWa1XA -V 2.0 list | grep dispersion_',
}
...
service swiftcheck
{
        ...
        bind            = 0.0.0.0
        server_args     = http://10.122.12.3:8080 10.122.12.2 5
        only_from       = 127.0.0.1 240.0.0.2 10.122.14.0/24 10.122.12.0/24
        per_source      = UNLIMITED
        cps             = 512 10
        flags           = IPv4
...
ring_devices { 'all':
  ...
  require  => 'Class[Swift]',
  storages => {'node-1' => {'fqdn' => 'node-1.domain.local', 'name' => 'node-1', 'node_roles' => ['ceph-osd', 'primary-controller'], 'storage_address' => '10.122.14.1', 'swift_zone' => '1', 'uid' => '1', 'user_node_name' => 'Untitled (2c:5e)'}},
}
