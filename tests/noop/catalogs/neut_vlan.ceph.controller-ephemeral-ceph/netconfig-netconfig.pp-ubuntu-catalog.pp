...
k_mod { '8021q':
  ...
  before => ['L2_bridge[br-fw-admin]', 'L2_bridge[br-mgmt]', 'L2_bridge[br-storage]', 'L2_bridge[br-ex]', 'L2_bridge[br-floating]', 'L2_bridge[br-prv]', 'L2_bridge[br-fw-admin]', 'L2_bridge[br-mgmt]', 'L2_bridge[br-storage]', 'L2_bridge[br-ex]', 'L2_bridge[br-floating]', 'L2_bridge[br-prv]', 'L2_bridge[br-fw-admin]', 'L2_bridge[br-mgmt]', 'L2_bridge[br-storage]', 'L2_bridge[br-ex]', 'L2_bridge[br-floating]', 'L2_bridge[br-prv]', 'L2_bridge[br-fw-admin]', 'L2_bridge[br-mgmt]', 'L2_bridge[br-storage]', 'L2_bridge[br-ex]', 'L2_bridge[br-floating]', 'L2_bridge[br-prv]', 'L2_bridge[br-fw-admin]', 'L2_bridge[br-mgmt]', 'L2_bridge[br-storage]', 'L2_bridge[br-ex]', 'L2_bridge[br-floating]', 'L2_bridge[br-prv]', 'L2_patch[patch__br-ex--br-floating]', 'L2_patch[patch__br-fw-admin--br-prv]', 'L2_bridge[br-fw-admin]', 'L2_bridge[br-mgmt]', 'L2_bridge[br-storage]', 'L2_bridge[br-ex]', 'L2_bridge[br-floating]', 'L2_bridge[br-prv]', 'L2_patch[patch__br-ex--br-floating]', 'L2_patch[patch__br-fw-admin--br-prv]', 'L2_port[eth0]', 'L2_port[eth0.101]', 'L2_port[eth0.102]', 'L2_port[eth1]', 'L2_port[eth0]', 'L2_port[eth0.101]', 'L2_port[eth0.102]', 'L2_port[eth1]', 'L2_port[eth0]', 'L2_port[eth0.101]', 'L2_port[eth0.102]', 'L2_port[eth1]', 'L2_port[eth0]', 'L2_port[eth0.101]', 'L2_port[eth0.102]', 'L2_port[eth1]'],
  module => '8021q',
}
...
l2_port { 'eth0.101':
  ...
  before    => ['Enable_hotplug[global]', 'Sysfs_config_value[rps_cpus]', 'Sysfs_config_value[xps_cpus]', 'Ping_host[10.122.11.1]'],
  bridge    => 'br-mgmt',
  interface => 'eth0.101',
  provider  => 'lnx',
  use_ovs   => 'true',
