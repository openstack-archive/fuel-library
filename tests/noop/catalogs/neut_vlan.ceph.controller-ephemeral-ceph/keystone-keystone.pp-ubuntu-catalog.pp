...
apache::vhost { 'keystone_wsgi_admin':
  ...
  scriptaliases               => [],
  serveraliases               => [],
  servername                  => 'node-1.domain.local',
  setenv                      => [],
  setenvif                    => [],
  ssl                         => 'false',
  ssl_cert                    => '/etc/ssl/certs/ssl-cert-snakeoil.pem',
...
class { 'Keystone::Endpoint':
  admin_url    => 'http://10.122.12.2:35357',
  internal_url => 'http://10.122.12.2:5000',
...
class { 'Keystone':
  ...
  database_connection                => 'mysql://keystone:0WzSQMdU@10.122.12.2/keystone?read_timeout=60',
...
export OS_AUTH_URL='http://10.122.12.2:5000/v2.0/'
...
keystone::resource::service_identity { 'keystone':
  admin_url             => 'http://10.122.12.2:35357/v2.0',
  auth_name             => 'keystone',
  ...
  ignore_default_tenant => 'false',
  internal_url          => 'http://10.122.12.2:5000/v2.0',
  name                  => 'keystone',
  password              => 'false',
...
keystone_config { 'database/connection':
  ...
  notify => ['Service[keystone]', 'Exec[keystone-manage db_sync]', 'Exec[keystone-manage pki_setup]', 'Service[httpd]'],
  secret => 'true',
  value  => 'mysql://keystone:0WzSQMdU@10.122.12.2/keystone?read_timeout=60',
}
