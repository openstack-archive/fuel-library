class { 'Glance::Api':
  ...
  auth_host                => '10.122.12.2',
  auth_port                => '35357',
  auth_protocol            => 'http',
  auth_type                => 'keystone',
  auth_uri                 => 'false',
  auth_url                 => 'http://10.122.12.2:5000/',
  backlog                  => '4096',
  before                   => 'Class[Glance::Cache::Pruner]',
  bind_host                => '10.122.12.3',
  bind_port                => '9292',
  ca_file                  => 'false',
  cert_file                => 'false',
  database_connection      => 'mysql://glance:vZsiQ0A3@10.122.12.2/glance?read_timeout=60',
...
class { 'Glance::Backend::Swift':
  ...
  swift_store_auth_address            => 'http://10.122.12.2:5000/v2.0/',
  swift_store_auth_version            => '2',
  swift_store_container               => 'glance',
  swift_store_create_container_on_put => 'True',
  swift_store_endpoint_type           => 'internalURL',
  swift_store_key                     => 'J3jcjTzv',
...
class { 'Openstack::Glance':
  ...
  glance_db_password             => 'vZsiQ0A3',
  glance_db_user                 => 'glance',
  glance_image_cache_max_size    => '5368709120',
  glance_tenant                  => 'services',
  glance_user                    => 'glance',
  glance_user_password           => 'J3jcjTzv',
  glance_vcenter_api_retry_count => '20',
  idle_timeout                   => '3600',
  keystone_host                  => '10.122.12.2',
  known_stores                   => ['glance.store.swift.Store', 'glance.store.http.Store'],
  max_overflow                   => '20',
  max_pool_size                  => '20',
  max_retries                    => '-1',
...
glance_api_config { 'database/connection':
  ...
  notify => ['Service[glance-api]', 'Exec[glance-manage db_sync]'],
  secret => 'true',
  value  => 'mysql://glance:vZsiQ0A3@10.122.12.2/glance?read_timeout=60',
}
...
glance_api_config { 'glance_store/swift_store_auth_address':
  name   => 'glance_store/swift_store_auth_address',
  notify => ['Service[glance-api]', 'Exec[glance-manage db_sync]'],
  value  => 'http://10.122.12.2:5000/v2.0/',
}

glance_api_config { 'glance_store/swift_store_auth_version':
  name   => 'glance_store/swift_store_auth_version',
  notify => ['Service[glance-api]', 'Exec[glance-manage db_sync]'],
  value  => '2',
}

glance_api_config { 'glance_store/swift_store_container':
  name   => 'glance_store/swift_store_container',
  notify => ['Service[glance-api]', 'Exec[glance-manage db_sync]'],
  value  => 'glance',
}

glance_api_config { 'glance_store/swift_store_create_container_on_put':
  name   => 'glance_store/swift_store_create_container_on_put',
  notify => ['Service[glance-api]', 'Exec[glance-manage db_sync]'],
  value  => 'True',
}

glance_api_config { 'glance_store/swift_store_endpoint_type':
  name   => 'glance_store/swift_store_endpoint_type',
  notify => ['Service[glance-api]', 'Exec[glance-manage db_sync]'],
  value  => 'internalURL',
}

glance_api_config { 'glance_store/swift_store_key':
  name   => 'glance_store/swift_store_key',
  notify => ['Service[glance-api]', 'Exec[glance-manage db_sync]'],
  value  => 'J3jcjTzv',
}

glance_api_config { 'glance_store/swift_store_large_object_size':
  name   => 'glance_store/swift_store_large_object_size',
  notify => ['Service[glance-api]', 'Exec[glance-manage db_sync]'],
  value  => '5120',
}

glance_api_config { 'glance_store/swift_store_region':
  name   => 'glance_store/swift_store_region',
  notify => ['Service[glance-api]', 'Exec[glance-manage db_sync]'],
  value  => 'RegionOne',
}

glance_api_config { 'glance_store/swift_store_user':
  name   => 'glance_store/swift_store_user',
  notify => ['Service[glance-api]', 'Exec[glance-manage db_sync]'],
...
glance_cache_config { 'glance_store/swift_store_auth_address':
  name   => 'glance_store/swift_store_auth_address',
  notify => ['Service[glance-api]', 'Exec[glance-manage db_sync]'],
  value  => 'http://10.122.12.2:5000/v2.0/',
}

glance_cache_config { 'glance_store/swift_store_auth_version':
  name   => 'glance_store/swift_store_auth_version',
  notify => ['Service[glance-api]', 'Exec[glance-manage db_sync]'],
  value  => '2',
}

glance_cache_config { 'glance_store/swift_store_container':
  name   => 'glance_store/swift_store_container',
  notify => ['Service[glance-api]', 'Exec[glance-manage db_sync]'],
  value  => 'glance',
}

glance_cache_config { 'glance_store/swift_store_create_container_on_put':
  name   => 'glance_store/swift_store_create_container_on_put',
  notify => ['Service[glance-api]', 'Exec[glance-manage db_sync]'],
  value  => 'True',
}

glance_cache_config { 'glance_store/swift_store_key':
  name   => 'glance_store/swift_store_key',
  notify => ['Service[glance-api]', 'Exec[glance-manage db_sync]'],
  value  => 'J3jcjTzv',
}

glance_cache_config { 'glance_store/swift_store_large_object_size':
  name   => 'glance_store/swift_store_large_object_size',
  notify => ['Service[glance-api]', 'Exec[glance-manage db_sync]'],
  value  => '5120',
}

glance_cache_config { 'glance_store/swift_store_region':
  name   => 'glance_store/swift_store_region',
  notify => ['Service[glance-api]', 'Exec[glance-manage db_sync]'],
  value  => 'RegionOne',
}

glance_cache_config { 'glance_store/swift_store_user':
  name   => 'glance_store/swift_store_user',
  notify => ['Service[glance-api]', 'Exec[glance-manage db_sync]'],
  value  => 'services:glance',
}
