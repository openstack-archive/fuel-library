class { 'Heat::Keystone::Auth':
  admin_url                   => 'http://10.122.12.2:8004/v1/%(tenant_id)s',
  auth_name                   => 'heat',
  ...
  internal_url                => 'http://10.122.12.2:8004/v1/%(tenant_id)s',
...
class { 'Heat::Keystone::Auth_cfn':
  admin_url           => 'http://10.122.12.2:8000/v1',
  auth_name           => 'heat-cfn',
  configure_endpoint  => 'true',
  configure_service   => 'true',
  configure_user      => 'true',
  ...
  internal_url        => 'http://10.122.12.2:8000/v1',
