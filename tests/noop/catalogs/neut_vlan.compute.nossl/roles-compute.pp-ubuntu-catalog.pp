...
augeas { 'libvirt-conf-uuid':
  changes => 'set host_uuid 06d4893b-7200-4596-a8fa-2a238ae03d5b
',
...
class { 'Nova::Compute':
  ...
  vnc_enabled                        => 'true',
  vnc_keymap                         => 'en-us',
  vncproxy_host                      => '10.122.6.6',
  vncproxy_path                      => '/vnc_auto.html',
  vncproxy_port                      => '6080',
  vncproxy_protocol                  => 'http',
  vncserver_proxyclient_address      => '10.122.7.3',
}
...
class { 'Nova':
  ...
  ensure_package                     => 'installed',
  glance_api_servers                 => '10.122.7.7:9292',
  ...
  memcached_servers                  => ['10.122.7.1:11211', '10.122.7.4:11211', '10.122.7.5:11211'],
  name                               => 'Nova',
  notification_driver                => [],
  ...
  rabbit_hosts                       => ['10.122.7.1:5673', ' 10.122.7.4:5673', ' 10.122.7.5:5673'],
  rabbit_password                    => 'WYcvKQyZ',
  rabbit_port                        => '5672',
...
class { 'Openstack::Compute':
  ...
  amqp_password                  => 'WYcvKQyZ',
  amqp_user                      => 'nova',
  auto_assign_floating_ip        => 'false',
  base_mac                       => 'fa:16:3e:00:00:00',
  cache_server_ip                => ['10.122.7.1', '10.122.7.4', '10.122.7.5'],
  cache_server_port              => '11211',
  ceilometer                     => 'false',
  ceilometer_metering_secret     => 'zjAKZxtd',
  ceilometer_user_password       => 'ycMeNdmo',
  cinder                         => 'true',
  cinder_db_dbname               => 'cinder',
  cinder_db_password             => 'qeN6frZT',
  cinder_db_user                 => 'cinder',
  cinder_iscsi_bind_addr         => '10.122.9.4',
  cinder_user_password           => '7Al0iWfl',
  ...
  neutron_settings               => {'L2' => {'base_mac' => 'fa:16:3e:00:00:00', 'phys_nets' => {'physnet2' => {'bridge' => 'br-prv', 'vlan_range' => '1000:1030'}}, 'segmentation_type' => 'vlan'}, 'L3' => {'use_namespaces' => 'true'}, 'database' => {'passwd' => 'bnQfjm1A'}, 'keystone' => {'admin_password' => 'glXcjTAY'}, 'metadata' => {'metadata_proxy_shared_secret' => 'orn88mVY'}, 'predefined_networks' => {'net04' => {'L2' => {'network_type' => 'vlan', 'physnet' => 'physnet2', 'router_ext' => 'false', 'segment_id' => ''}, 'L3' => {'enable_dhcp' => 'true', 'floating' => '', 'gateway' => '10.122.8.1', 'nameservers' => ['8.8.4.4', '8.8.8.8'], 'subnet' => '10.122.8.0/24'}, 'shared' => 'false', 'tenant' => 'admin'}, 'net04_ext' => {'L2' => {'network_type' => 'local', 'physnet' => '', 'router_ext' => 'true', 'segment_id' => ''}, 'L3' => {'enable_dhcp' => 'false', 'floating' => '10.122.6.130:10.122.6.254', 'gateway' => '10.122.6.1', 'nameservers' => [], 'subnet' => '10.122.6.0/24'}, 'shared' => 'false', 'tenant' => 'admin'}}},
  neutron_user_password          => 'glXcjTAY',
  nova_hash                      => {'db_password' => 'of31Rxsy', 'state_path' => '/var/lib/nova', 'user_password' => 'n0KfayKg', 'vncproxy_protocol' => 'http'},
  ...
  state_path                     => '/var/lib/nova',
  storage_hash                   => {'ephemeral_ceph' => 'false', 'images_ceph' => 'false', 'images_vcenter' => 'false', 'iser' => 'false', 'metadata' => {'label' => 'Storage', 'weight' => '60'}, 'objects_ceph' => 'false', 'osd_pool_size' => '2', 'per_pool_pg_nums' => {'.rgw' => '128', 'backups' => '128', 'compute' => '128', 'default_pg_num' => '128', 'images' => '128', 'volumes' => '128'}, 'pg_num' => '128', 'volumes_ceph' => 'false', 'volumes_lvm' => 'true'},
...
nova_config { 'DEFAULT/memcached_servers':
  ...
  notify => 'Exec[post-nova_config]',
  value  => '10.122.7.1:11211,10.122.7.4:11211,10.122.7.5:11211',
}
...
nova_config { 'DEFAULT/novncproxy_base_url':
  ...
  notify => 'Exec[post-nova_config]',
  value  => 'http://10.122.6.6:6080/vnc_auto.html',
}
...
nova_config { 'glance/api_servers':
  ...
  notify => 'Exec[post-nova_config]',
  value  => '10.122.7.7:9292',
}

nova_config { 'keymgr/fixed_key':
  name   => 'keymgr/fixed_key',
  notify => 'Exec[post-nova_config]',
  value  => '264ecf97cf69264f775e549fe5fd1ce3db6a92df94d37745819892803a83b19c',
}
...
nova_config { 'oslo_messaging_rabbit/rabbit_hosts':
  ...
  notify => 'Exec[post-nova_config]',
  value  => '10.122.7.1:5673, 10.122.7.4:5673, 10.122.7.5:5673',
}
