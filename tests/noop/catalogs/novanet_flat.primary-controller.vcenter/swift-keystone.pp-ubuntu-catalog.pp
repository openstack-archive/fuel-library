...
class { 'Swift::Keystone::Auth':
  admin_url              => 'http://10.108.2.2:8080/v1/AUTH_%(tenant_id)s',
  admin_url_s3           => 'http://10.108.2.2:8080',
  auth_name              => 'swift',
  configure_endpoint     => 'true',
  configure_s3_endpoint  => 'true',
  email                  => 'swift@localhost',
  internal_url           => 'http://10.108.2.2:8080/v1/AUTH_%(tenant_id)s',
  internal_url_s3        => 'http://10.108.2.2:8080',
...
keystone::resource::service_identity { 'swift_s3':
  admin_url             => 'http://10.108.2.2:8080',
  auth_name             => 'swift_s3',
  configure_endpoint    => 'true',
  configure_service     => 'true',
  ...
  ignore_default_tenant => 'false',
  internal_url          => 'http://10.108.2.2:8080',
  name                  => 'swift_s3',
  password              => 'false',
