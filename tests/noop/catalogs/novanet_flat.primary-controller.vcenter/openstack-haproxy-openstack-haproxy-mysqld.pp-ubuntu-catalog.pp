...
concat::fragment { 'mysqld_balancermember_mysqld':
  ...
  content => '  server node-1 10.108.2.4:3307  check port 49000 inter 20s fastinter 2s downinter 2s rise 3 fall 3
  server node-2 10.108.2.5:3307 backup check port 49000 inter 20s fastinter 2s downinter 2s rise 3 fall 3
  server node-3 10.108.2.6:3307 backup check port 49000 inter 20s fastinter 2s downinter 2s rise 3 fall 3
',
