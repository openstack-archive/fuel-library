...
apache::vhost { 'keystone_wsgi_admin':
  ...
  scriptaliases               => [],
  serveraliases               => [],
  servername                  => 'node-1.test.domain.local',
  setenv                      => [],
  setenvif                    => [],
  ssl                         => 'false',
  ssl_cert                    => '/etc/ssl/certs/ssl-cert-snakeoil.pem',
...
class { 'Keystone::Endpoint':
  admin_url    => 'http://10.108.2.2:35357',
  internal_url => 'http://10.108.2.2:5000',
...
class { 'Keystone':
  ...
  database_connection                => 'mysql://keystone:rscfOUx4@10.108.2.2/keystone?read_timeout=60',
...
class { 'Openstack::Auth_file':
  admin_password         => 'ceilometerHA',
  admin_tenant           => 'ceilometerHA',
  admin_user             => 'ceilometerHA',
  cinder_endpoint_type   => 'internalURL',
  controller_node        => '10.108.2.2',
...
class { 'Openstack::Keystone':
  ...
  memcache_servers      => ['10.108.2.4', '10.108.2.5', '10.108.2.6'],
...
export OS_TENANT_NAME='ceilometerHA'
export OS_PROJECT_NAME='ceilometerHA'
export OS_USERNAME='ceilometerHA'
export OS_PASSWORD='ceilometerHA'
export OS_AUTH_URL='http://10.108.2.2:5000/v2.0/'
...
keystone::resource::service_identity { 'keystone':
  admin_url             => 'http://10.108.2.2:35357/v2.0',
  auth_name             => 'keystone',
  ...
  ignore_default_tenant => 'false',
  internal_url          => 'http://10.108.2.2:5000/v2.0',
  name                  => 'keystone',
  password              => 'false',
...
keystone_config { 'database/connection':
  ...
  notify => ['Service[keystone]', 'Exec[keystone-manage db_sync]', 'Exec[keystone-manage pki_setup]', 'Service[httpd]'],
  secret => 'true',
  value  => 'mysql://keystone:rscfOUx4@10.108.2.2/keystone?read_timeout=60',
}
...
keystone_user_role { 'ceilometerHA@ceilometerHA':
  ensure => 'present',
  name   => 'ceilometerHA@ceilometerHA',
  roles  => 'admin',
}
...
service { 'httpd':
  ...
  before     => ['Keystone_endpoint[RegionOne/keystone]', 'Keystone_role[admin]', 'Keystone_service[keystone]', 'Keystone_tenant[services]', 'Keystone_tenant[ceilometerHA]', 'Keystone_user[ceilometerHA]', 'Keystone_user_role[ceilometerHA@ceilometerHA]', 'Haproxy_backend_status[keystone-public]', 'Haproxy_backend_status[keystone-admin]'],
  enable     => 'true',
  hasrestart => 'true',
  name       => 'apache2',
