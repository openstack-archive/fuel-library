class { 'Cluster::Haproxy':
  ...
  stats_ipaddresses  => ['10.108.2.2', '10.108.2.2', '10.108.2.2', '127.0.0.1'],
}
...
cs_resource { 'p_haproxy':
  ...
  parameters      => {'debug' => 'true', 'ns' => 'haproxy', 'other_networks' => '10.108.0.0/24 10.108.4.0/24 10.108.2.0/24 10.108.1.0/24'},
  primitive_class => 'ocf',
