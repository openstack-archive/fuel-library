...
class { 'Cluster':
  corosync_nodes   => {'node-1.test.domain.local' => {'id' => '1', 'ip' => '10.108.2.4'}, 'node-2.test.domain.local' => {'id' => '2', 'ip' => '10.108.2.5'}, 'node-3.test.domain.local' => {'id' => '3', 'ip' => '10.108.2.6'}},
...
nodelist {
  node {
    ...
    ring0_addr: 10.108.2.4
    nodeid: 1
  }
  node {
    # node-2.test.domain.local
    ring0_addr: 10.108.2.5
    nodeid: 2
  }
  node {
    # node-3.test.domain.local
    ring0_addr: 10.108.2.6
    nodeid: 3
  }
}
...
pcmk_nodes { 'pacemaker':
  ...
  name                => 'pacemaker',
  nodes               => {'node-1.test.domain.local' => {'id' => '1', 'ip' => '10.108.2.4'}, 'node-2.test.domain.local' => {'id' => '2', 'ip' => '10.108.2.5'}, 'node-3.test.domain.local' => {'id' => '3', 'ip' => '10.108.2.6'}},
}
