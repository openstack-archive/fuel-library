...
augeas { 'libvirt-conf-uuid':
  changes => 'set host_uuid 23804057-ad57-4c4e-af7b-668c3a4cf5b7
',
...
class { 'Nova::Compute':
  ...
  vncserver_proxyclient_address      => '10.122.12.6',
}
...
class { 'Nova':
  ...
  ensure_package                     => 'installed',
  glance_api_servers                 => '10.122.12.2:9292',
  ...
  memcached_servers                  => '10.122.12.3:11211',
  name                               => 'Nova',
  notification_driver                => [],
  ...
  rabbit_hosts                       => '10.122.12.3:5673',
  rabbit_password                    => '06nkQaUt',
  rabbit_port                        => '5672',
...
class { 'Openstack::Compute':
  ...
  amqp_password                  => '06nkQaUt',
  amqp_user                      => 'nova',
  auto_assign_floating_ip        => 'false',
  base_mac                       => 'fa:16:3e:00:00:00',
  cache_server_ip                => '10.122.12.3',
  cache_server_port              => '11211',
  ceilometer                     => 'false',
  ceilometer_metering_secret     => 'k3mrQHsh',
  ceilometer_user_password       => '5fXkIlEW',
  cinder                         => 'true',
  cinder_db_dbname               => 'cinder',
  cinder_db_password             => 'te0Sd4Ai',
  cinder_db_user                 => 'cinder',
  cinder_iscsi_bind_addr         => '10.122.14.2',
  cinder_user_password           => 'HaDqJdMp',
  ...
  neutron_settings               => {'L2' => {'base_mac' => 'fa:16:3e:00:00:00', 'phys_nets' => {'physnet2' => {'bridge' => 'br-prv', 'vlan_range' => '1000:1030'}}, 'segmentation_type' => 'vlan'}, 'L3' => {'use_namespaces' => 'true'}, 'database' => {'passwd' => 'DVHUmPBa'}, 'keystone' => {'admin_password' => 'muG6m84W'}, 'metadata' => {'metadata_proxy_shared_secret' => 'P3Hi55Hg'}, 'predefined_networks' => {'net04' => {'L2' => {'network_type' => 'vlan', 'physnet' => 'physnet2', 'router_ext' => 'false', 'segment_id' => ''}, 'L3' => {'enable_dhcp' => 'true', 'floating' => '', 'gateway' => '10.122.13.1', 'nameservers' => ['8.8.4.4', '8.8.8.8'], 'subnet' => '10.122.13.0/24'}, 'shared' => 'false', 'tenant' => 'admin'}, 'net04_ext' => {'L2' => {'network_type' => 'local', 'physnet' => '', 'router_ext' => 'true', 'segment_id' => ''}, 'L3' => {'enable_dhcp' => 'false', 'floating' => '10.122.11.130:10.122.11.254', 'gateway' => '10.122.11.1', 'nameservers' => [], 'subnet' => '10.122.11.0/24'}, 'shared' => 'false', 'tenant' => 'admin'}}},
  neutron_user_password          => 'muG6m84W',
  nova_hash                      => {'db_password' => 'seh61drS', 'state_path' => '/var/lib/nova', 'user_password' => 'vhdwzqrw', 'vncproxy_protocol' => 'https'},
  ...
  state_path                     => '/var/lib/nova',
  storage_hash                   => {'ephemeral_ceph' => 'true', 'images_ceph' => 'false', 'images_vcenter' => 'false', 'iser' => 'false', 'metadata' => {'label' => 'Storage', 'weight' => '60'}, 'objects_ceph' => 'false', 'osd_pool_size' => '2', 'per_pool_pg_nums' => {'.rgw' => '64', 'backups' => '64', 'compute' => '512', 'default_pg_num' => '64', 'images' => '64', 'volumes' => '64'}, 'pg_num' => '64', 'volumes_ceph' => 'false', 'volumes_lvm' => 'true'},
...
nova_config { 'glance/api_servers':
  ...
  notify => 'Exec[post-nova_config]',
  value  => '10.122.12.2:9292',
}

nova_config { 'keymgr/fixed_key':
  name   => 'keymgr/fixed_key',
  notify => 'Exec[post-nova_config]',
  value  => '0842c95fc8bc15d2031d1838ebe2059d16cd39248fc5a1bc74638cfe0c5e8687',
}
...
nova_config { 'libvirt/disk_cachemodes':
  ...
  notify => 'Exec[post-nova_config]',
  value  => '"network=writeback,block=none"',
}
