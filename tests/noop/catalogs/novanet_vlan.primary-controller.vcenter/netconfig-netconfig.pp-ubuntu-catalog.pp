...
k_mod { '8021q':
  ...
  before => ['L2_bridge[br-fw-admin]', 'L2_bridge[br-storage]', 'L2_bridge[br-mgmt]', 'L2_bridge[br-ex]', 'L2_bridge[br-fw-admin]', 'L2_bridge[br-storage]', 'L2_bridge[br-mgmt]', 'L2_bridge[br-ex]', 'L2_bridge[br-fw-admin]', 'L2_bridge[br-storage]', 'L2_bridge[br-mgmt]', 'L2_bridge[br-ex]', 'L2_bridge[br-fw-admin]', 'L2_bridge[br-storage]', 'L2_bridge[br-mgmt]', 'L2_bridge[br-ex]', 'L2_port[eth0]', 'L2_port[eth1]', 'L2_port[eth2]', 'L2_port[eth2.101]', 'L2_port[eth4]', 'L2_port[eth4.102]', 'L2_port[eth0]', 'L2_port[eth1]', 'L2_port[eth2]', 'L2_port[eth2.101]', 'L2_port[eth4]', 'L2_port[eth4.102]', 'L2_port[eth0]', 'L2_port[eth1]', 'L2_port[eth2]', 'L2_port[eth2.101]', 'L2_port[eth4]', 'L2_port[eth4.102]', 'L2_port[eth0]', 'L2_port[eth1]', 'L2_port[eth2]', 'L2_port[eth2.101]', 'L2_port[eth4]', 'L2_port[eth4.102]', 'L2_port[eth0]', 'L2_port[eth1]', 'L2_port[eth2]', 'L2_port[eth2.101]', 'L2_port[eth4]', 'L2_port[eth4.102]', 'L2_port[eth0]', 'L2_port[eth1]', 'L2_port[eth2]', 'L2_port[eth2.101]', 'L2_port[eth4]', 'L2_port[eth4.102]'],
  module => '8021q',
}
...
l23_stored_config { 'eth1':
  ...
  before   => ['Enable_hotplug[global]', 'L2_port[eth1]', 'L3_ifconfig[eth1]'],
  bridge   => 'br-ex',
  ipaddr   => 'none',
  method   => 'manual',
  name     => 'eth1',
...
l23_stored_config { 'eth2.101':
  ensure    => 'present',
  before    => ['Enable_hotplug[global]', 'L2_port[eth2.101]'],
  bridge    => 'br-mgmt',
  name      => 'eth2.101',
  provider  => 'lnx_ubuntu',
  vlan_dev  => 'eth2',
...
l23_stored_config { 'eth4.102':
  ensure    => 'present',
  before    => ['Enable_hotplug[global]', 'L2_port[eth4.102]'],
  bridge    => 'br-storage',
  name      => 'eth4.102',
  provider  => 'lnx_ubuntu',
  vlan_dev  => 'eth4',
...
l23network::l2::port { 'eth2':
  ...
  port     => 'eth2',
  provider => 'lnx',
  require  => 'L23network::L3::Ifconfig[eth1]',
  use_ovs  => 'false',
}

l23network::l2::port { 'eth4.102':
  ensure   => 'present',
  bridge   => 'br-storage',
  name     => 'eth4.102',
  port     => 'eth4.102',
...
l23network::l2::port { 'eth4':
  ...
  port     => 'eth4',
  provider => 'lnx',
  require  => 'L23network::L2::Port[eth2.101]',
  use_ovs  => 'false',
}
...
notify { 'SDN':
  message => 'add-br(br-fw-admin) -> endpoint(br-fw-admin) -> add-br(br-storage) -> endpoint(br-storage) -> add-br(br-mgmt) -> endpoint(br-mgmt) -> add-br(br-ex) -> endpoint(br-ex) -> add-port(eth0) -> add-port(eth1) -> endpoint(eth1) -> add-port(eth2) -> add-port(eth2.101) -> add-port(eth4) -> add-port(eth4.102)',
  name    => 'SDN',
}
