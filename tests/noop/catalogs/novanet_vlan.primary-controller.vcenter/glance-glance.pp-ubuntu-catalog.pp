class { 'Glance::Api':
  ...
  ca_file                  => 'false',
  cert_file                => 'false',
  database_connection      => 'mysql://glance:ICT8nfNP@172.16.1.2/glance?read_timeout=60',
...
class { 'Glance::Backend::Swift':
  ...
  swift_store_auth_address            => 'http://172.16.1.2:5000/v2.0/',
  swift_store_auth_version            => '2',
  swift_store_container               => 'glance',
  swift_store_create_container_on_put => 'True',
  swift_store_endpoint_type           => 'internalURL',
  swift_store_key                     => 'ONErUJGW',
...
class { 'Openstack::Glance':
  ...
  glance_db_password             => 'ICT8nfNP',
  glance_db_user                 => 'glance',
  glance_image_cache_max_size    => '10737418240',
  glance_tenant                  => 'services',
  glance_user                    => 'glance',
  glance_user_password           => 'ONErUJGW',
  glance_vcenter_api_retry_count => '20',
  glance_vcenter_datacenter      => '',
  glance_vcenter_datastore       => '',
  glance_vcenter_host            => '',
  glance_vcenter_password        => '',
  glance_vcenter_user            => '',
  idle_timeout                   => '3600',
  keystone_host                  => '172.16.1.2',
  known_stores                   => ['glance.store.swift.Store', 'glance.store.http.Store'],
  max_overflow                   => '20',
  max_pool_size                  => '20',
  max_retries                    => '-1',
...
glance_api_config { 'database/connection':
  ...
  notify => ['Service[glance-api]', 'Exec[glance-manage db_sync]'],
  secret => 'true',
  value  => 'mysql://glance:ICT8nfNP@172.16.1.2/glance?read_timeout=60',
}
...
glance_api_config { 'glance_store/swift_store_auth_address':
  ...
  notify => ['Service[glance-api]', 'Exec[glance-manage db_sync]'],
  value  => 'http://172.16.1.2:5000/v2.0/',
}
