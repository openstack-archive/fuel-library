class { 'Nova::Keystone::Auth':
  admin_url               => 'http://172.16.1.2:8774/v2/%(tenant_id)s',
  admin_url_v3            => 'http://172.16.1.2:8774/v3',
  auth_name               => 'nova',
  auth_name_v3            => 'novav3',
  ...
  ec2_admin_url           => 'http://172.16.1.2:8773/services/Admin',
  ec2_internal_url        => 'http://172.16.1.2:8773/services/Cloud',
  ec2_public_url          => 'https://public.fuel.local:8773/services/Cloud',
  email                   => 'nova@localhost',
  internal_url            => 'http://172.16.1.2:8774/v2/%(tenant_id)s',
  internal_url_v3         => 'http://172.16.1.2:8774/v3',
...
keystone::resource::service_identity { 'nova ec2 service, user nova_ec2':
  admin_url             => 'http://172.16.1.2:8773/services/Admin',
  auth_name             => 'nova_ec2',
  configure_endpoint    => 'true',
  ...
  internal_url          => 'http://172.16.1.2:8773/services/Cloud',
...
keystone::resource::service_identity { 'nova v3 service, user novav3':
  admin_url             => 'http://172.16.1.2:8774/v3',
  auth_name             => 'novav3',
  configure_endpoint    => 'true',
  configure_service     => 'true',
  configure_user        => 'false',
  ...
  ignore_default_tenant => 'false',
  internal_url          => 'http://172.16.1.2:8774/v3',
