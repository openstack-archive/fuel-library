...
concat::fragment { 'mysqld_balancermember_mysqld':
  ...
  content => '  server node-5 172.16.1.6:3307  check port 49000 inter 20s fastinter 2s downinter 2s rise 3 fall 3
  server node-6 172.16.1.3:3307 backup check port 49000 inter 20s fastinter 2s downinter 2s rise 3 fall 3
  server node-3 172.16.1.5:3307 backup check port 49000 inter 20s fastinter 2s downinter 2s rise 3 fall 3
',
