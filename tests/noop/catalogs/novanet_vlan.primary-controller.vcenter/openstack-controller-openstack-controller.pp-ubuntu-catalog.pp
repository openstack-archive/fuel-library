...
class { 'Nova::Api':
  admin_password        => '77CHLe8y',
  admin_tenant_name     => 'services',
  admin_user            => 'nova',
  api_bind_address      => '172.16.1.5',
  ...
  identity_uri          => 'false',
  keystone_ec2_url      => 'http://172.16.1.2:5000/v2.0/ec2tokens',
  manage_service        => 'true',
...
class { 'Nova':
  ...
  ca_file                            => 'false',
  cert_file                          => 'false',
  database_connection                => 'mysql://nova:owRNCV7f@172.16.1.2/nova?read_timeout=60',
  database_idle_timeout              => '3600',
  debug                              => 'false',
  enabled_ssl_apis                   => ['ec2', 'metadata', 'osapi_compute'],
  ensure_package                     => 'installed',
  glance_api_servers                 => '172.16.1.2:9292',
  ...
  memcached_servers                  => ['172.16.1.3:11211', '172.16.1.5:11211', '172.16.1.6:11211'],
  name                               => 'Nova',
  notification_driver                => [],
...
class { 'Openstack::Controller':
  ...
  cache_server_ip                => ['172.16.1.3', '172.16.1.5', '172.16.1.6'],
  ...
  nova_db_user                   => 'nova',
  nova_hash                      => {'db_password' => 'owRNCV7f', 'state_path' => '/var/lib/nova', 'user_password' => '77CHLe8y'},
  ...
  nova_user                      => 'nova',
  nova_user_password             => '77CHLe8y',
  nova_user_tenant               => 'services',
  novnc_address                  => '172.16.1.5',
  num_networks                   => '1',
...
exec { 'create-m1.micro-flavor':
  ...
  environment => ['OS_TENANT_NAME=services', 'OS_USERNAME=nova', 'OS_PASSWORD=77CHLe8y', 'OS_AUTH_URL=http://172.16.1.2:5000/v2.0/', 'OS_ENDPOINT_TYPE=internalURL', 'OS_REGION_NAME=RegionOne', 'NOVA_ENDPOINT_TYPE=internalURL'],
...
nova_config { 'DEFAULT/keystone_ec2_url':
  ...
  notify => 'Exec[post-nova_config]',
  value  => 'http://172.16.1.2:5000/v2.0/ec2tokens',
}
...
nova_config { 'DEFAULT/memcached_servers':
  ...
  notify => 'Exec[post-nova_config]',
  value  => '172.16.1.3:11211,172.16.1.5:11211,172.16.1.6:11211',
}
...
nova_config { 'DEFAULT/novncproxy_base_url':
  ...
  notify => 'Exec[post-nova_config]',
  value  => 'http://172.16.1.5:6080/vnc_auto.html',
}
...
nova_config { 'database/connection':
  ...
  secret => 'true',
  value  => 'mysql://nova:owRNCV7f@172.16.1.2/nova?read_timeout=60',
}
...
nova_floating_range { '172.16.0.128-172.16.0.254':
  ...
  name            => '172.16.0.128-172.16.0.254',
  pool            => 'nova',
  username        => 'admin',
}
