class { 'Cluster::Haproxy':
  ...
  other_networks     => '10.109.0.0/24 192.168.1.0/24 172.16.1.0/24 172.16.0.0/24',
  primary_controller => 'true',
  stats_ipaddresses  => ['172.16.1.2', '172.16.1.2', '172.16.1.2', '127.0.0.1'],
}
...
cs_resource { 'p_haproxy':
  ...
  parameters      => {'debug' => 'false', 'ns' => 'haproxy', 'other_networks' => '10.109.0.0/24 192.168.1.0/24 172.16.1.0/24 172.16.0.0/24'},
  primitive_class => 'ocf',
...
# OCF Parameters
                                    ...
                                    export OCF_RESKEY_other_networks='10.109.0.0/24 192.168.1.0/24 172.16.1.0/24 172.16.0.0/24'
