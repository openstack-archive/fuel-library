...
class { 'Heat::Engine':
  ...
  heat_metadata_server_url            => 'http://172.16.1.2:8000',
  heat_stack_user_role                => 'heat_stack_user',
  heat_waitcondition_server_url       => 'http://172.16.1.2:8000/v1/waitcondition',
  heat_watch_server_url               => 'http://172.16.1.2:8003',
  manage_service                      => 'true',
  name                                => 'Heat::Engine',
  package_ensure                      => 'present',
...
class { 'Heat::Keystone::Domain':
  auth_url           => 'http://172.16.1.2:35357/v2.0',
  domain_admin       => 'heat_admin',
  domain_admin_email => 'heat_admin@localhost',
  domain_name        => 'heat',
  domain_password    => 'Iu130Azv',
  keystone_admin     => 'heat',
  keystone_password  => 'Iu130Azv',
...
class { 'Heat':
  ...
  debug                              => 'false',
  identity_uri                       => 'false',
  keystone_ec2_uri                   => 'http://172.16.1.2:5000/v2.0',
  ...
  sql_connection                     => 'mysql://heat:vvKwC5nk@172.16.1.2/heat?read_timeout=60',
  sync_db                            => 'true',
  use_stderr                         => 'false',
  use_syslog                         => 'true',
  verbose                            => 'true',
...
class { 'Openstack::Heat':
  ...
  amqp_user                     => 'nova',
  api_bind_host                 => '172.16.1.5',
  api_bind_port                 => '8004',
  api_cfn_bind_host             => '172.16.1.5',
  api_cfn_bind_port             => '8000',
  api_cloudwatch_bind_host      => '172.16.1.5',
...
heat_config { 'DEFAULT/auth_encryption_key':
  ...
  notify => ['Service[heat-engine]', 'Service[heat-api]', 'Service[heat-api-cfn]', 'Service[heat-api-cloudwatch]'],
  value  => 'cce511b05ad01c693e2cc93d90a28fc2',
}
...
heat_config { 'DEFAULT/heat_waitcondition_server_url':
  ...
  notify => ['Service[heat-engine]', 'Service[heat-api]', 'Service[heat-api-cfn]', 'Service[heat-api-cloudwatch]'],
  value  => 'http://172.16.1.2:8000/v1/waitcondition',
}
...
heat_config { 'database/connection':
  ...
  secret => 'true',
  value  => 'mysql://heat:vvKwC5nk@172.16.1.2/heat?read_timeout=60',
}
