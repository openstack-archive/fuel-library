...
concat::fragment { 'swift_balancermember_swift':
  ...
  content => '  server node-5 172.16.1.6:8080  check port 49001 inter 15s fastinter 2s downinter 8s rise 3 fall 3
  server node-6 172.16.1.3:8080  check port 49001 inter 15s fastinter 2s downinter 8s rise 3 fall 3
  server node-3 172.16.1.5:8080  check port 49001 inter 15s fastinter 2s downinter 8s rise 3 fall 3
',
...
haproxy::listen { 'swift':
  bind             => {'172.16.0.3:8080' => ['ssl', 'crt', '/var/lib/astute/haproxy/public_haproxy.pem'], '172.16.1.2:8080' => ''},
  bind_options     => '',
