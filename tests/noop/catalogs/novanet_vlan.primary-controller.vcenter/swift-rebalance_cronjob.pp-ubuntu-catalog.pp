...
rsync -q -a rsync://192.168.1.3/swift_server/account.ring.gz /etc/swift/account.ring.gz
rsync -q -a rsync://192.168.1.3/swift_server/object.ring.gz /etc/swift/object.ring.gz
rsync -q -a rsync://192.168.1.3/swift_server/container.ring.gz /etc/swift/container.ring.gz
