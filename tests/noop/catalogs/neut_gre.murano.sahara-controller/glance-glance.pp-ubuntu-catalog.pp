class { 'Glance::Api':
  ...
  ca_file                  => 'false',
  cert_file                => 'false',
  database_connection      => 'mysql://glance:0UYCFNfc@192.168.0.2/glance?read_timeout=60',
...
glance_api_config { 'database/connection':
  ...
  notify => ['Service[glance-api]', 'Exec[glance-manage db_sync]'],
  secret => 'true',
  value  => 'mysql://glance:0UYCFNfc@192.168.0.2/glance?read_timeout=60',
}
