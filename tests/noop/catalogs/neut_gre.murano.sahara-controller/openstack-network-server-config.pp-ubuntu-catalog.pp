...
class { 'Neutron::Server':
  ...
  auth_user                        => 'neutron',
  database_connection              => 'mysql://neutron:QRpCfPk8@192.168.0.2/neutron?&read_timeout=60',
...
neutron_config { 'database/connection':
  ...
  notify => 'Service[neutron-server]',
  secret => 'true',
  value  => 'mysql://neutron:QRpCfPk8@192.168.0.2/neutron?&read_timeout=60',
}
