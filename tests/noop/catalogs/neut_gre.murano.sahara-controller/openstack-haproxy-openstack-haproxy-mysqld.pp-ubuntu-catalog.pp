...
concat::fragment { 'mysqld_balancermember_mysqld':
  ...
  content => '  server node-128 192.168.0.2:3307  check port 49000 inter 20s fastinter 2s downinter 2s rise 3 fall 3
  server node-129 192.168.0.3:3307 backup check port 49000 inter 20s fastinter 2s downinter 2s rise 3 fall 3
  server node-131 192.168.0.4:3307 backup check port 49000 inter 20s fastinter 2s downinter 2s rise 3 fall 3
',
