...
k_mod { '8021q':
  ...
  before => ['L2_bridge[br-fw-admin]', 'L2_bridge[br-mgmt]', 'L2_bridge[br-storage]', 'L2_bridge[br-ex]', 'L2_bridge[br-floating]', 'L2_bridge[br-fw-admin]', 'L2_bridge[br-mgmt]', 'L2_bridge[br-storage]', 'L2_bridge[br-ex]', 'L2_bridge[br-floating]', 'L2_bridge[br-fw-admin]', 'L2_bridge[br-mgmt]', 'L2_bridge[br-storage]', 'L2_bridge[br-ex]', 'L2_bridge[br-floating]', 'L2_bridge[br-fw-admin]', 'L2_bridge[br-mgmt]', 'L2_bridge[br-storage]', 'L2_bridge[br-ex]', 'L2_bridge[br-floating]', 'L2_bridge[br-fw-admin]', 'L2_bridge[br-mgmt]', 'L2_bridge[br-storage]', 'L2_bridge[br-ex]', 'L2_bridge[br-floating]', 'L2_patch[patch__br-ex--br-floating]', 'L2_port[eth0]', 'L2_port[eth0.102]', 'L2_port[eth0.101]', 'L2_port[eth1]', 'L2_port[eth0]', 'L2_port[eth0.102]', 'L2_port[eth0.101]', 'L2_port[eth1]', 'L2_port[eth0]', 'L2_port[eth0.102]', 'L2_port[eth0.101]', 'L2_port[eth1]', 'L2_port[eth0]', 'L2_port[eth0.102]', 'L2_port[eth0.101]', 'L2_port[eth1]'],
  module => '8021q',
}
...
l23_stored_config { 'br-ex':
  ...
  name            => 'br-ex',
  provider        => 'lnx_ubuntu',
  vendor_specific => {'phy_interfaces' => ['eth1']},
}
...
notify { 'SDN':
  message => 'add-br(br-fw-admin) -> endpoint(br-fw-admin) -> add-br(br-mgmt) -> endpoint(br-mgmt) -> add-br(br-storage) -> endpoint(br-storage) -> add-br(br-ex) -> endpoint(br-ex) -> add-br(br-floating) -> endpoint(br-floating) -> add-patch(patch__br-ex--br-floating) -> add-port(eth0) -> add-port(eth0.102) -> add-port(eth0.101) -> add-port(eth1)',
  name    => 'SDN',
}
