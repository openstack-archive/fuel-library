...
cinder_config { 'database/connection':
  ...
  secret => 'true',
  value  => 'mysql://cinder:VwpNB13X@192.168.0.5/cinder?charset=utf8&read_timeout=60',
}
...
class { 'Cinder::Api':
  ...
  enabled                     => 'true',
  identity_uri                => 'http://192.168.0.5:5000/',
  ...
  os_privileged_user_auth_url => 'http://192.168.0.5:5000/',
  os_privileged_user_name     => 'cinder',
  os_privileged_user_password => 'o9msdnTx',
...
class { 'Cinder':
  ...
  database_connection                => 'mysql://cinder:VwpNB13X@192.168.0.5/cinder?charset=utf8&read_timeout=60',
...
class { 'Openstack::Cinder':
  ...
  region               => 'RegionOne',
  service_workers      => '4',
  sql_connection       => 'mysql://cinder:VwpNB13X@192.168.0.5/cinder?charset=utf8&read_timeout=60',
