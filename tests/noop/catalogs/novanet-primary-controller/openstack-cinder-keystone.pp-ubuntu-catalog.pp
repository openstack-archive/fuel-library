class { 'Cinder::Keystone::Auth':
  admin_url              => 'http://192.168.0.5:8776/v1/%(tenant_id)s',
  admin_url_v2           => 'http://192.168.0.5:8776/v2/%(tenant_id)s',
  auth_name              => 'cinder',
  ...
  internal_url           => 'http://192.168.0.5:8776/v1/%(tenant_id)s',
  internal_url_v2        => 'http://192.168.0.5:8776/v2/%(tenant_id)s',
...
keystone::resource::service_identity { 'cinderv2':
  admin_url             => 'http://192.168.0.5:8776/v2/%(tenant_id)s',
  auth_name             => 'cinderv2',
  configure_endpoint    => 'true',
  configure_service     => 'true',
  ...
  ignore_default_tenant => 'false',
  internal_url          => 'http://192.168.0.5:8776/v2/%(tenant_id)s',
  name                  => 'cinderv2',
  password              => 'false',
