...
cs_resource { 'p_rabbitmq-server':
  ...
  parameters      => {'admin_password' => 'zrMvquYX', 'admin_user' => 'nova', 'command_timeout' => ''--signal=KILL'', 'debug' => 'false', 'erlang_cookie' => 'EOKOWXQREETZSHFNTPEY', 'node_port' => '5673'},
  primitive_class => 'ocf',
  primitive_type  => 'rabbitmq-server',
  provided_by     => 'fuel',
}
...
exec { '/var/lib/rabbitmq/rabbitmqadmin':
  command   => 'curl -k --noproxy localhost --retry 30 --retry-delay 6 -f -L -o /var/lib/rabbitmq/rabbitmqadmin http://nova:zrMvquYX@localhost:15672/cli/rabbitmqadmin',
...
# OCF Parameters
                                    ...
                                    export OCF_RESKEY_admin_password='zrMvquYX'
...
file { 'rabbitmq-env.config':
  ...
  content => 'NODE_IP_ADDRESS=192.168.0.4
NODE_PORT=5673
...
staging::file { 'rabbitmqadmin':
  ...
  source      => 'http://nova:zrMvquYX@localhost:15672/cli/rabbitmqadmin',
  subdir      => 'rabbitmq',
