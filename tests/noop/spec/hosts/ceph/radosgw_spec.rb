...
describe manifest do
  shared_examples 'catalog' do
    ...
    it 'should have explicit ordering between LB classes and particular actions' do
      expect(graph).to ensure_transitional_dependency("Haproxy_backend_status[keystone-public]", "Class[ceph::keystone]")
      expect(graph).to ensure_transitional_dependency("Haproxy_backend_status[keystone-admin]", "Class[ceph::keystone]")
    end
