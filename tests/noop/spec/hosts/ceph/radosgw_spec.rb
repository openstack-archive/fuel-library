...
describe manifest do
  shared_examples 'catalog' do
    ...
    it 'should have explicit ordering between LB classes and particular actions' do
      expect(graph).to ensure_transitional_dependency("Class[ceph::keystone]", "Haproxy_backend_status[keystone-public]")
      expect(graph).to_not ensure_transitional_dependency("Class[ceph::keystone]", "Haproxy_backend_status[keystone-admin]")
    end
