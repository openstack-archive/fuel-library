...
describe manifest do
  shared_examples 'catalog' do
    ironic_user_password = task.hiera_structure 'ironic/user_password'
    ...
    nova_db_password = task.hiera_structure 'nova/db_password', 'nova'
    nova_db_user = task.hiera_structure 'nova/db_user', 'nova'
    nova_db_name = task.hiera_structure 'nova/db_name', 'nova'
