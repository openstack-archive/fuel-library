...
describe manifest do
  shared_examples 'catalog' do
    ...
    it 'should contain token_caching parameter for keystone set to false' do
     ...
     it 'should declare keystone::wsgi::apache class with 2 workers on 2 physical CPU system' do
     ...
     it 'should declare keystone::wsgi::apache class with 16 workers on 24 physical CPU system' do
       facts[:physicalprocessorcount] = 24
       should contain_class('keystone::wsgi::apache').with(
         'threads' => '1',
         'workers' => '16',
       )
