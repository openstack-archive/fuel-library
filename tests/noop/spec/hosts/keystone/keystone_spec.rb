...
describe manifest do
  shared_examples 'catalog' do
    ...
    let (:cache_memcache_servers) do
      "localhost:#{memcache_server_port}"
    end
    ...
    it 'should configure  keystone with parameters' do
      ...
      should contain_keystone_config('cache/memcache_dead_retry').with(:value => '15')
      ...
      should contain_keystone_config('memcache/dead_retry').with(:value => '15')
