...
describe manifest do
  shared_examples 'catalog' do
    ...
    bind_address               = Noop.hiera('internal_address')
    ...
    if murano_enabled
      ...
      it 'should declare murano class correctly' do
        should contain_class('murano').with(
                   ...
                   #'service_host'        => api_bind_host, # TODO: smakar Fix AFTER https://bugs.launchpad.net/fuel/+bug/1486048
      ...
      it 'should declare murano::api class correctly' do
        should contain_class('murano::api').with(
                   #'host' => api_bind_host, TODO: smakar Fix AFTER https://bugs.launchpad.net/fuel/+bug/1486048
                   'port' => api_bind_port,
               )
      end
