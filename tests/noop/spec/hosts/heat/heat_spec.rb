...
describe manifest do
  shared_examples 'catalog' do
    ...
    it 'should configure the database connection string' do
      ...
      should contain('openstack::heat').with(
        :db_connection => "mysql://#{heat_hash[:db_user]}:#{heat_hash[:db_password]}@#{database_vip}/#{heat_db_name}#{extra_params}"
      )
    end
