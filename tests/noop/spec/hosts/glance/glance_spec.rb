...
describe manifest do
  ...
  shared_examples 'catalog' do
    ...
    #vCenter
    glance_vc_host = Noop.hiera_structure 'glance/vc_host'
    glance_vc_user = Noop.hiera_structure 'glance/vc_user'
    glance_vc_password = Noop.hiera_structure 'glance/vc_password'
    glance_vc_datacenter = Noop.hiera_structure 'glance/vc_datacenter'
    glance_vc_datastore = Noop.hiera_structure 'glance/vc_datastore'
    glance_vc_image_dir = Noop.hiera_structure 'glance/vc_image_dir'
    glance_vc_ca_file = Noop.hiera_structure 'glance/vc_ca_file'
