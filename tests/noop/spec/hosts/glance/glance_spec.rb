...
describe manifest do
  ...
  shared_examples 'catalog' do
    ...
    password          = glance_config.fetch('user_password')
    username          = glance_config.fetch('user', 'glance')
    project_name      = glance_config.fetch('tenant', 'services')
    ...
    it 'should configure glance api config' do
      ...
      should contain_glance_api_config('keystone_authtoken/username').with_value(username)
      should contain_glance_api_config('keystone_authtoken/password').with_value(password)
      should contain_glance_api_config('keystone_authtoken/project_name').with_value(project_name)
    ...
    it 'should configure glance glare config' do
      ...
      should contain_glance_glare_config('keystone_authtoken/username').with_value(username)
      should contain_glance_glare_config('keystone_authtoken/password').with_value(password)
      should contain_glance_glare_config('keystone_authtoken/project_name').with_value(project_name)
    ...
    it 'should configure glance registry config' do
      ...
      should contain_glance_registry_config('keystone_authtoken/username').with_value(username)
      should contain_glance_registry_config('keystone_authtoken/password').with_value(password)
      should contain_glance_registry_config('keystone_authtoken/project_name').with_value(project_name)
