...
describe manifest do
  ...
  shared_examples 'catalog' do
    ...
    it 'should configure glance api config' do
      ...
      should contain_glance_api_config('keystone_authtoken/identity_uri').with_value(identity_uri)
      should contain_glance_api_config('keystone_authtoken/keystone_user').with_value(glance_config.fetch('user', 'glance'))
      should contain_glance_api_config('keystone_authtoken/keystone_password').with_value(glance_config.fetch('user_password'))
      should contain_glance_api_config('keystone_authtoken/admin_tenant_name').with_value(glance_config.fetch('project_name', 'services'))
