...
describe manifest do
  shared_examples 'catalog' do
    ...
    if Noop.hiera_structure('use_ssl/swift_public', false)
      ...
      public_address  = Noop.hiera_structure('use_ssl/swift_public_hostname') || public_vip
    elsif public_ssl
    ...
    if Noop.hiera_structure('use_ssl/swift_internal', false)
      ...
      internal_address  = Noop.hiera_structure('use_ssl/swift_internal_hostname') || public_vip
