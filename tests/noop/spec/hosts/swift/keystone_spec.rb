...
describe manifest do
  shared_examples 'catalog' do
    ...
    if task.hiera_structure('use_ssl/swift_public', false)
      public_protocol = 'https'
      public_address  = task.hiera_structure('use_ssl/swift_public_hostname')
    ...
    if task.hiera_structure('use_ssl/swift_internal', false)
      internal_protocol = 'https'
      internal_address  = task.hiera_structure('use_ssl/swift_internal_hostname')
    ...
    if task.hiera_structure('use_ssl/swift_admin', false)
      admin_protocol = 'https'
      admin_address  = task.hiera_structure('use_ssl/swift_admin_hostname')
    elsif swift['management_vip']
      admin_protocol = 'http'
    ...
    tenant              = task.hiera_structure('swift/tenant', 'services')
