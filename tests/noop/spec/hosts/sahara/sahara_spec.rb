...
describe manifest do
  shared_examples 'catalog' do
    ...
    public_url    = "#{public_protocol}://#{public_ip}:#{api_bind_port}/v1.1/%(tenant_id)s"
    admin_url     = "http://#{service_endpoint}:#{api_bind_port}/v1.1/%(tenant_id)s"
    internal_url    = "http://#{service_endpoint}:#{api_bind_port}/v1.1/%(tenant_id)s"
