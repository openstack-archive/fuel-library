...
describe manifest do
  shared_examples 'catalog' do
    ...
    rabbit_heartbeat_timeout_treshold = Noop.puppet_function 'pick', aodh_hash['rabbit_heartbeat_timeout_treshold'], rabbit_hash['heartbeat_timeout_treshold'], 60
    ...
    it 'should configure RabbitMQ Heartbeat parameters' do
      should contain_aodh_config('oslo_messaging_rabbit/heartbeat_timeout_threshold').with_value(rabbit_heartbeat_timeout_treshold)
