...
describe manifest do
  shared_examples 'catalog' do
    ...
    metadata_host    = Noop.node_hash['internal_address']
    ...
    if use_neutron
      ...
      it 'should configure multi_host, send_arp_for_ha, metadata_host in nova.conf for nova-network' do
        ...
        should contain_nova_config('DEFAULT/metadata_host') # TODO: smakar Fix AFTER https://bugs.launchpad.net/fuel/+bug/1486048
