...
describe manifest do
  ...
  shared_examples 'catalog' do
    ...
    it "should contain the defined containers exec chain subscribed to the docker service" do
      should contain_exec('container0build').that_subscribes_to('Service[docker]')
    end
