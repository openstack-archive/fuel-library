...
describe manifest do
  shared_examples 'catalog' do
    ...
    it 'should contain correct firewall rules' do

      it 'should set firewall chains to DROP by default' do
      ...
      it "shouldn't purge the custom external filters" do
      ...
      it 'should contain the firewall rules' do
