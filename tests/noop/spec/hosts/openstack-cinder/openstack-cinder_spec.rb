...
describe manifest do
  ...
  rabbit_heartbeat_timeout_treshold = Noop.puppet_function 'pick', cinder_hash['rabbit_heartbeat_timeout_treshold'], rabbit_hash['heartbeat_timeout_treshold'], 60
  ...
  it 'should configure RabbitMQ Heartbeat parameters' do
    should contain_cinder_config('oslo_messaging_rabbit/heartbeat_timeout_threshold').with_value(rabbit_heartbeat_timeout_treshold)
