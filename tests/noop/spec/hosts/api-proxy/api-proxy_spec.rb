...
describe manifest do
  ...
  test_ubuntu_and_centos(manifest) do |context|
    track_resources = ['class[apache]', 'apache::vhost[apache_api_proxy]', 'firewall[007 tinyproxy]']
    context.include_examples 'saved_catalog', track_resources
  end
end
