...
describe manifest do
  shared_examples 'catalog' do
    ...
    let(:nova_hash) { Noop.hiera_structure 'nova_hash' }
    ...
    let(:keystone_indentity_uri) { "#{admin_auth_protocol}://#{admin_auth_address}:35357/" }
    let(:keystone_ec2_url) { "#{keystone_auth_url}v2.0/ec2tokens" }
