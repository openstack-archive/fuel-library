module FuelRelationshipGraphMatchers
  class EnsureTransitionalDependency
    ...
    def failure_message
      ...
      msg << "#{@before} dependents are: #{@dependents}\n"
      msg
    end
  ...
  def ensure_transitional_dependency(before, after)
    EnsureTransitionalDependency.new(before, after)
  end
end
